...
'indicatorIde.editor.fastLessThanSlow': 'Fast line parameter must be less than slow line parameter',
  ...
  'aiAssetAnalysis.opportunities.title': 'Radar biến động giá',
  'aiAssetAnalysis.opportunities.empty': 'Chưa có cơ hội giao dịch',
  'aiAssetAnalysis.opportunities.analyze': 'Phân tích',
  'aiAssetAnalysis.opportunities.updateHint': 'Quét dựa trên quy tắc dựa trên biến động giá và các chỉ báo kỹ thuật. Chỉ để quan sát; không phải lời khuyên đầu tư.',
  ...
  'trading-assistant.form.localDeploymentHint': 'IBKR và MT5 thuộc loại giao diện giao dịch thực bên ngoài, cần triển khai chạy cục bộ QuantBrew, không hỗ trợ chế độ SaaS đám mây. Vui lòng đảm bảo bạn đã cài đặt và cấu hình phần mềm giao dịch liên quan (TWS/IB Gateway hoặc MT5 terminal) trên máy cục bộ.',
  ...
  'profile.exchange.openAccountPromo': 'Đăng ký độc quyền QuantBrew — nhận hoa hồng lên đến 20%',
  ...
  'profile.exchange.localDeploymentHint': 'Nhà môi giới này yêu cầu triển khai cục bộ QuantBrew để sử dụng.',
  ...
  'trading-assistant.editor.docsIntroDesc': 'Đây là các API và móc vòng đời thường dùng cho chiến lược script QuantBrew, giúp bạn vừa viết vừa tra cứu.',
  ...
  'quickTrade.tpslRecordOnlyHint': 'Lưu ý: Giá chốt lời/cắt lỗ chỉ được lưu trong hồ sơ giao dịch QuantBrew. Chúng không được gửi đến sàn dưới dạng lệnh điều kiện hoặc kích hoạt đóng. Nếu cần, hãy đặt chốt lời/cắt lỗ trực tiếp trên sàn.',
