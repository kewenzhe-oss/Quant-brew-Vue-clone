...
'indicatorIde.editor.fastLessThanSlow': 'Fast line parameter must be less than slow line parameter',
  ...
  'trading-assistant.form.localDeploymentHint': 'IBKR và MT5 thuộc loại giao diện giao dịch thực bên ngoài, cần triển khai chạy cục bộ PostSoma Core, không hỗ trợ chế độ SaaS đám mây. Vui lòng đảm bảo bạn đã cài đặt và cấu hình phần mềm giao dịch liên quan (TWS/IB Gateway hoặc MT5 terminal) trên máy cục bộ.',
  ...
  'profile.exchange.openAccountPromo': 'Đăng ký độc quyền PostSoma Core — nhận hoa hồng lên đến 20%',
  ...
  'profile.exchange.localDeploymentHint': 'Nhà môi giới này yêu cầu triển khai cục bộ PostSoma Core để sử dụng.',
  ...
  'trading-assistant.editor.docsIntroDesc': 'Đây là các API và móc vòng đời thường dùng cho chiến lược script PostSoma Core, giúp bạn vừa viết vừa tra cứu.',
  ...
  'quickTrade.tpslRecordOnlyHint': 'Lưu ý: Giá chốt lời/cắt lỗ chỉ được lưu trong hồ sơ giao dịch PostSoma Core. Chúng không được gửi đến sàn dưới dạng lệnh điều kiện hoặc kích hoạt đóng. Nếu cần, hãy đặt chốt lời/cắt lỗ trực tiếp trên sàn.',
