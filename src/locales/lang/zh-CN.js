...
const locale = {
  ...
  'user.login.infos': 'PostSoma Core 是一个 AI 多智能体股票分析辅助工具，不具备证券投资咨询资质。平台中的所有分析结果、评分、参考意见均由 AI 基于历史数据自动生成，仅供学习、研究与技术交流使用,不构成任何投资建议或决策依据。股票投资存在市场风险、流动性风险、政策风险等多种风险，可能导致本金损失。用户应基于自身风险承受能力独立决策，使用本工具产生的任何投资行为及其后果由用户自行承担。市场有风险，投资需谨慎。',
  ...
  'user.login.legal.content': 'PostSoma Core 是一个 AI 多智能体股票分析辅助工具，不具备证券投资咨询资质。平台中的所有分析结果、评分、参考意见均由 AI 基于历史数据自动生成，仅供学习、研究与技术交流使用，不构成任何投资建议或决策依据。股票投资存在市场风险、流动性风险、政策风险等多种风险，可能导致本金损失。用户应基于自身风险承受能力独立决策，使用本工具产生的任何投资行为及其后果由用户自行承担。市场有风险，投资需谨慎。',
  ...
  'trading-assistant.form.localDeploymentHint': 'IBKR 和 MT5 属于外挂类实盘接口，需要本地部署运行 PostSoma Core，不支持云端 SaaS 模式。请确保您已在本地安装并配置相关交易软件（TWS/IB Gateway 或 MT5 终端）。',
  ...
  'profile.exchange.openAccountPromo': 'PostSoma Core 专属开户，享最高 20% 返佣',
  ...
  'profile.exchange.localDeploymentHint': '此券商需要在本地部署 PostSoma Core 才能使用。',
  ...
  'trading-assistant.editor.docsIntroDesc': '这里展示的是 PostSoma Core 脚本策略可用的常用 API 与生命周期说明，方便你边写边查。',
