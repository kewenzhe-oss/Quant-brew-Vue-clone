...
const locale = {
  ...
  'menu.stockResearch': 'Research Workbench',
  // ---- QuantBrew Navigation ----
  'menu.dashboard.today': 'Daily Briefing',
  'menu.assetSnapshot': 'Market Watch',
  'menu.tradePlan': 'Strategy Planner',
  'menu.myPlan': 'Research Notebook',
  'menu.learning': 'Theory Library',
  // ---- Trading Bot Page ----
  ...
  'aiAssetAnalysis.opportunities.title': 'Live Market Pulse Radar',
  'aiAssetAnalysis.opportunities.empty': 'No opportunities found',
  'aiAssetAnalysis.opportunities.analyze': 'Analyze',
  'aiAssetAnalysis.opportunities.updateHint': 'Real-time watchlist-driven observation scan. Jump into deep analysis on trigger.',
  'aiAssetAnalysis.observation.title': 'Real-time Observation Window',
  'aiAssetAnalysis.observation.subtitle': 'Watch market assets, run instant analysis, and capture live market pulses.',
  'aiAssetAnalysis.opportunities.provenance.ruleBased': 'Rule-Based Scan',
  'aiAssetAnalysis.opportunities.provenance.basis': 'Market Price & Technical Rules',
  'aiAssetAnalysis.opportunities.provenance.observationOnly': 'For observation only, not investment advice',
  'aiAssetAnalysis.opportunities.provenance.asOf': 'Data as of: {time}',
  ...
  'user.login.infos': 'QuantBrew is a rule-based heuristic research operating system. All analysis results, scores, and references are generated based on historical data and are for analytical research and reference purposes only. They do not constitute financial advice or investment recommendations. All investment decisions involve risk, including the possible loss of principal. Users must exercise independent judgment and bear all risks associated with their investment actions.',
  ...
  'user.login.subtitle': 'Think clearly. Act deliberately.',
  'user.login.tagline': 'Macro context, asset research, and disciplined execution in one calm workspace.',
  ...
  'trading-assistant.form.localDeploymentHint': 'IBKR and MT5 are external trading interfaces that require local deployment of QuantBrew. Cloud SaaS mode is not supported. Please ensure you have installed and configured the trading software (TWS/IB Gateway or MT5 terminal) on your local machine.',
  ...
  'profile.description': 'Your identity and workspace preferences',
  'profile.tab.profile': 'Profile',
  'profile.tab.security': 'Security',
  'profile.tab.notifications': 'Notifications',
  'profile.tab.exports': 'Exports',
  'profile.manageApiKey': 'Manage API Keys',
  'profile.tile.apiKeyTitle': 'API Key Management',
  'profile.tile.apiKeyMeta': '{count} saved connections',
  'profile.tile.notificationTitle': 'Notification Defaults',
  'profile.tile.notificationMeta': '{count} active channels',
  'profile.tile.securityTitle': 'Security Review',
  'profile.tile.securityMeta': 'Email verification required',
  'profile.tile.creditsTitle': 'Usage & Export Trail',
  'profile.tile.creditsMeta': '{count} available credits',
  'profile.risk.postureTitle': 'Default Risk Posture',
  'profile.risk.postureSubtitle': 'Plan discipline before execution',
  'profile.risk.postureTag': 'Review-first',
  'profile.risk.positionSizing': 'Position Sizing',
  'profile.risk.positionSizingVal': 'Defined per plan',
  'profile.risk.positionSizingDesc': 'Budget and cadence are set in Trade Plan before a plan is archived.',
  'profile.risk.alerts': 'Alerts',
  'profile.risk.alertsVal': 'Preference based',
  'profile.risk.alertsDesc': 'Notification defaults apply to watch points and plan review reminders.',
  'profile.risk.connectedAccounts': 'Connected Accounts',
  'profile.risk.connectedAccountsVal': 'Credential gated',
  'profile.risk.connectedAccountsDesc': 'External API keys stay managed separately from research workflows.',
  ...
  'globalMarket.gatewaySubtitle': 'Open the full MacroMicro economic calendar',
  'globalMarket.gatewayAction': 'View Full Calendar',
  ...
  'trading-assistant.editor.docsIntroDesc': 'These are the commonly used QuantBrew script strategy APIs and lifecycle hooks, so you can code and look up usage side by side.',
  ...
  'quickTrade.tpslRecordOnlyHint': 'Note: TP/SL prices are saved in QuantBrew trade records only. They are not sent to the exchange as native TP/SL or trigger orders. Set exchange-side TP/SL on the exchange if you need that.',
  ...
  'indicatorIde.codeEditor': 'Strategy Logic Workspace',
  'indicatorIde.modified': 'Modified',
  'indicatorIde.aiGenerate': 'Assistant Generator',
  'indicatorIde.aiAssistHint': 'This tool is only an assistant for generating logic drafts. Please review and optimize the code before running or backtesting.',
  'indicatorIde.aiPromptPlaceholder': 'Describe the logic or formula draft you want to generate, e.g. "Long when price breaks above Bollinger Bands Upper Band"...',
  'indicatorIde.generating': 'Generating...',
  'indicatorIde.generateCode': 'Generate Logic Draft',
  ...
  'indicatorIde.runIndicatorOnChartShort': 'Run',
  'indicatorIde.stopIndicatorOnChartShort': 'Stop',
  ...
  'indicatorIde.aiTuneExplain': 'Iteratively searches for the best parameter combination across multiple rounds using logical models. No manual range setup needed — ideal for quick exploration.',
  ...
  'indicatorIde.noSignalsWarning': 'The current strategy did not generate any executable signals, so no trade records or equity curve changes will be produced.',
  'indicatorIde.noParamsWarning': 'No indicator parameters declared in code (using # @param). Smart Tuning is currently focusing on risk and capital management parameters.',
  'indicatorIde.fallbackAppliedInfo': 'LLM candidate generation degraded due to LLM call failure or short output. Deterministic fallback parameters are being tested to ensure diverse optimization.',
  'indicatorIde.guideExpand': 'Guide',
  'indicatorIde.guideCollapse': 'Collapse',
  'indicatorIde.guideSubTitle': 'Learn indicator syntax, tunable parameter declarations, and risk rules.',
  'indicatorIde.tipParamTitle': 'Declare Tunable Parameters',
  'indicatorIde.tipParamDesc': 'Use # @param prefix to let AI optimization engines fine-tune your parameters.',
  'indicatorIde.tipStrategyTitle': 'Configure Position & Risk',
  'indicatorIde.tipStrategyDesc': 'Configure default stop-loss, take-profit, and size settings inside code, which are read during strategy creation.',
  'indicatorIde.readFullGuide': 'Read Full Developer Guide',
  'indicatorIde.localCheckFailed': 'Local code execution check failed',
  'indicatorIde.pythonNotReady': 'Python engine is not ready yet, please wait for it to load completely before running backtest',
  'indicatorIde.diagTitle': 'Zero Trades Diagnostic Analysis',
  'indicatorIde.diagDesc': 'The backtest completed successfully, but the total trade count is 0. This is typically caused by the following reasons. Please check them one by one:',
  'indicatorIde.diagMismatchTitle': 'Chart has visualization signals, but backtest trade count is 0',
  'indicatorIde.diagMismatchCount': 'The system successfully executed and rendered {count} buy/sell markers on the chart, but the historical backtest execution resulted in 0 trades.',
  'indicatorIde.diagMismatchDesc': 'This indicates a disconnect between the "chart visualization signal layer" and the "backtest execution matching layer". Please focus on auditing the following four underlying issues:',
  'indicatorIde.diagMismatchReasonA': 'MTF timeframe data range gap: When Multi-Timeframe (MTF) backtesting is enabled, trade execution is simulated using the execution timeframe (e.g. 5m). Due to limitations in data APIs (such as yfinance), granular 5m data is only available for the last 60 days. If your backtest range is 1 year, the execution timeframe data only covers the last 60 days. As a result, daily signals from the first 10 months will accumulate and execute simultaneously on the first available 5m candle, which often violates position guards and gets skipped.',
  'indicatorIde.diagMismatchReasonB': 'DatetimeIndex reindexing wipeout: If your indicator code alters the DataFrame structure (e.g. using reset_index, dropna, or filtering rows) and does not properly restore the "time" column or keep the original length, the backend alignment process will fail to match indices, converting all elements to False (zeroing out signals).',
  'indicatorIde.diagMismatchReasonC': 'df[\'buy\']/df[\'sell\'] column assignment mismatch: The chart renders markers from the local Pyodide output[\'signals\'] structure, whereas the backend backtester strictly reads the df[\'buy\'] and df[\'sell\'] columns in the DataFrame. If the columns are missing or not assigned boolean values, the chart will display markers but the backtester will result in 0 trades.',
  'indicatorIde.diagMismatchReasonD': 'signalTiming shift and position guard conflict: The default trade timing is "next_bar_open". Shifting buy/sell signals by 1 bar can push execution outside the date range, filter them out under the selected "Trade Direction" (e.g., a shifted signal is classified as short while the setting is long-only), or cause conflicting simultaneous signals that are skipped by position guards (e.g., position == 0).',
  'indicatorIde.diagReason1Title': 'buy / sell signal columns are not assigned or not boolean',
  'indicatorIde.diagReason1Body': 'The backtest engine relies on df[\'buy\'] and df[\'sell\'] to trigger entries/exits. Please ensure you assign boolean series to these columns in your code, e.g.:',
  'indicatorIde.diagReason2Title': 'Logic condition is too strict to generate any signals',
  'indicatorIde.diagReason2Body': 'The entry criteria may be too restrictive (e.g. multiple indicators resonating or thresholds set too high), resulting in zero bars triggering signals. Try running the indicator on the chart first to verify if B/S markers appear, or loosen the conditions.',
  'indicatorIde.diagReason3Title': 'Trade direction mismatch with signal types',
  'indicatorIde.diagReason3Body': 'For example, the backtest trade direction is set to \'long\' but the code only generates sell/short signals, or vice versa. Ensure the backtest panel \'Trade Direction\' matches your script\'s logic.',
  'indicatorIde.diagReason4Title': 'Insufficient data or market suspension in backtest range',
  'indicatorIde.diagReason4Body': 'Within the selected date range, there might be no K-line history or too few data points (e.g. fewer bars than your MA rolling period). Try using a more liquid pair (like BTC/USDT) or extending the date range.',
  'indicatorIde.diagActionTitle': 'Next Steps & Suggestions:',
  'indicatorIde.diagAction1': 'Click \'Run\' in the editor toolbar and check if B/S markers appear on the K-line chart.',
  'indicatorIde.diagAction2': 'Check output logs to ensure there are no hidden runtime exceptions.',
  'indicatorIde.diagAction3': 'Use the create button to generate a default template (Dual MA Crossover) and run a backtest to compare.',
  'indicatorIde.runBacktest': 'Run Backtest',
  'indicatorIde.runHistoricalBacktest': 'Run Historical Backtest',
  ...
  'indicatorIde.aiOptimize': 'Parameter Suggestions',
  'indicatorIde.aiOptimizeHint': 'Recommend potential optimized parameter combinations based on the current backtesting data.',
  ...
  'profile.exchange.openAccountPromo': 'QuantBrew exclusive signup — up to 20% commission rebate',
  ...
  'profile.exchange.localDeploymentHint': 'This broker requires local deployment of QuantBrew to use.',
  ...
  // Daily Briefing
  'dailyBriefing.title': 'Daily Briefing',
  'dailyBriefing.subtitle': 'Key market insights and consensus summary before and after trading hours',
  'dailyBriefing.todayMarket': 'Market Pulse (AI Signal Pool)',
  'dailyBriefing.price': 'Price',
  'dailyBriefing.change24h': '24h Change',
  'dailyBriefing.signal': 'Signal',
  'dailyBriefing.defaultReason': 'AI detected unusual volatility',
  'dailyBriefing.noMarketData': 'No market volatility data available',
  'dailyBriefing.macroSentiment': 'Macro Sentiment Overview',
  'dailyBriefing.upcomingFocus': 'Key Watchlist Events',
  'dailyBriefing.defaultEvent': 'Event',
  'dailyBriefing.noUpcomingEvents': 'No major events scheduled for today',
  'dailyBriefing.noBriefingData': 'No briefing data available',
  'dailyBriefing.waitingForUpdate': 'Awaiting market data updates',
  'dailyBriefing.noSummary': 'No summary available',
  'dailyBriefing.symbolBriefing': '{symbol} Analysis Briefing',
  'dailyBriefing.latestBriefing': 'Latest Market Briefing',
  'dailyBriefing.fetchedLatestAnalysis': 'Latest AI analysis retrieved',
  'dailyBriefing.sentimentIndex': 'Sentiment Index: {value}',
  'dailyBriefing.crypto': 'Crypto',
  'dailyBriefing.notice': 'Notice',

  // Strategy Planner
  'tradePlan.title': 'Strategy Plan Drafter',
  'tradePlan.subtitle': 'Enter your target, budget, period, and risk profile to generate a disciplined research strategy plan draft. Plans do not predict prices and are not investment advice.',
  'tradePlan.configTitle': 'Strategy Configuration',
  'tradePlan.symbolLabel': 'Symbol / Target Code',
  'tradePlan.symbolPlaceholder': 'e.g. AAPL / QQQ / BTC',
  'tradePlan.assetTypeLabel': 'Asset Type',
  'tradePlan.planTypeLabel': 'Plan Type',
  'tradePlan.planType.longTermDca': 'Long-term DCA',
  'tradePlan.planType.stagedEntry': 'Staged Entry',
  'tradePlan.planType.riskControl': 'Risk Control',
  'tradePlan.budgetLabel': 'Total Budget ($)',
  'tradePlan.durationLabel': 'Duration / Execution Cycle',
  'tradePlan.frequencyLabel': 'Frequency / Allocation Cadence',
  'tradePlan.riskLabel': 'Risk Profile',
  'tradePlan.risk.conservative': 'Conservative',
  'tradePlan.risk.balanced': 'Balanced',
  'tradePlan.risk.aggressive': 'Aggressive',
  'tradePlan.thesisLabel': 'Optional Thesis / Investment Thesis',
  'tradePlan.thesisPlaceholder': 'Why do you want to focus on this target? e.g., long-term allocation, industry growth, risk diversification, etc.',
  'tradePlan.sidebar.title': 'What will the Strategy Planner do?',
  'tradePlan.sidebar.item1': 'Generate paced staging intervals',
  'tradePlan.sidebar.item2': 'Define strategy invalidation triggers',
  'tradePlan.sidebar.item3': 'Highlight risk points to review',
  'tradePlan.sidebar.item4': 'Simulate scenarios instead of predicting returns',
  'tradePlan.disclaimer': 'The generated thesis is a draft research strategy framework. It is not investment advice, does not predict prices, and does not guarantee returns.',
  'tradePlan.button.generating': 'Generating...',
  'tradePlan.button.generate': 'Generate Strategy Thesis',
  'tradePlan.error.generate': 'Unable to generate strategy thesis draft. Please try again later.',
  'tradePlan.error.save': 'Unable to save strategy plan. Please try again later.',
  'tradePlan.tech.title': 'Technical Workspace / Helper',
  'tradePlan.tech.desc': 'If you want to use charts, indicators, or custom trading code to assist in determining entry ranges, staged prices, or stop-loss rules, open the Advanced Technical Workspace.',
  'tradePlan.tech.note': 'These tools are only for helping adjust plan parameters, do not constitute investment advice, and do not predict price movements.',
  'tradePlan.tech.button': 'Open Technical Workspace',
  'tradePlan.draft.title': 'Strategy Thesis Outline',
  'tradePlan.draft.summary': 'Thesis Summary',
  'tradePlan.draft.budgetAllocation': 'Budget Allocation',
  'tradePlan.draft.basePool': 'Base DCA Pool',
  'tradePlan.draft.reservePool': 'Drawdown Reserve Pool',
  'tradePlan.draft.cashPool': 'Cash Buffer',
  'tradePlan.draft.cadence': 'Investment Cadence',
  'tradePlan.draft.schedule': 'Budget Schedule',
  'tradePlan.draft.columns.period': 'Period',
  'tradePlan.draft.columns.amount': 'Suggested Amount',
  'tradePlan.draft.columns.note': 'Description',
  'tradePlan.draft.actionRules': 'Action Rules',
  'tradePlan.draft.rules.continue': 'Conditions to Continue',
  'tradePlan.draft.rules.pause': 'Conditions to Pause',
  'tradePlan.draft.rules.reserve': 'Conditions to Use Reserves',
  'tradePlan.draft.rules.review': 'Conditions to Review',
  'tradePlan.draft.stagedEntry': 'Staging Rules',
  'tradePlan.draft.checklist': 'Asset Checklist',
  'tradePlan.draft.invalidation': 'Invalidation Conditions',
  'tradePlan.draft.cashReserve': 'Cash Reserve',
  'tradePlan.draft.riskReminder': 'Risk Reminder',
  'tradePlan.draft.reviewFreq': 'Review Frequency',
  'tradePlan.draft.scenarios': 'Scenario Simulation',
  'tradePlan.draft.scenarios.base': 'Base Case',
  'tradePlan.draft.scenarios.upside': 'Upside/Bull Case',
  'tradePlan.draft.scenarios.sideways': 'Sideways/Ranging Case',
  'tradePlan.draft.scenarios.stress': 'Stress Case',
  'tradePlan.draft.disclaimer': 'This thesis is an AI-generated disciplined draft. It does not constitute investment advice, predict prices, or guarantee returns.',
  'tradePlan.button.saving': 'Saving...',
  'tradePlan.button.save': 'Save to Research Notebook',
  'tradePlan.saveSuccess': 'Strategy saved to Research Notebook successfully',
  'tradePlan.viewPlan': 'View My Strategy Plan →',

  // My Plan
  'myPlan.title': 'My Plan',
  'myPlan.subtitle': 'My Plan',
  'myPlan.desc': 'Save your long-term DCA schedules, staged entry rules, and risk disciplines. Plans are not for predicting markets, but for keeping you anchored to your rules during volatility.',
  'myPlan.loading': 'Loading...',
  'myPlan.retry': 'Retry',
  'myPlan.tabs.active': 'Active',
  'myPlan.tabs.paused': 'Paused',
  'myPlan.tabs.completed': 'Completed',
  'myPlan.tabs.archived': 'Archived',
  'myPlan.menu.view': 'View Details',
  'myPlan.menu.edit': 'Edit Plan',
  'myPlan.menu.pause': 'Pause Plan',
  'myPlan.menu.activate': 'Resume Plan',
  'myPlan.menu.archive': 'Archive Plan',
  'myPlan.menu.resumePaused': 'Restore to Paused',
  'myPlan.menu.delete': 'Delete Plan',
  'myPlan.preview.basePool': 'Base DCA Pool',
  'myPlan.preview.reservePool': 'Drawdown Reserve Pool',
  'myPlan.preview.cashPool': 'Cash Buffer',
  'myPlan.preview.budget': 'Total Budget',
  'myPlan.preview.created': 'Created At',
  'myPlan.preview.review': 'Review',
  'myPlan.status.active': 'Active',
  'myPlan.status.paused': 'Paused',
  'myPlan.status.draft': 'Draft',
  'myPlan.status.completed': 'Completed',
  'myPlan.status.cancelled': 'Cancelled',
  'myPlan.status.archived': 'Archived',
  'myPlan.empty.noActive': 'You have no active plans',
  'myPlan.empty.noArchived': 'You have no archived plans',
  'myPlan.empty.noRecords': 'No matching plan records',
  'myPlan.empty.desc': 'Create a long-term DCA or staged entry plan to stay disciplined amid market volatility.',
  'myPlan.empty.actionCreate': 'Create a Plan',
  'myPlan.empty.actionLearn': 'Learn about DCA',
  'myPlan.edu.title': 'What is a Trade Plan?',
  'myPlan.edu.item1.title': 'Entry Logic',
  'myPlan.edu.item1.desc': 'Document your reasons for buying, instead of relying on intuition or hype.',
  'myPlan.edu.item2.title': 'Invalidation Triggers',
  'myPlan.edu.item2.desc': 'Predefine what changes would mean the plan\'s underlying thesis is no longer valid.',
  'myPlan.edu.item3.title': 'Staged Execution',
  'myPlan.edu.item3.desc': 'Avoid entering all at once; buy in stages according to the plan to manage uncertainty.',
  'myPlan.edu.item4.title': 'Regular Reviews',
  'myPlan.edu.item4.desc': 'Periodically review the execution rather than making impulsive modifications.',
  'myPlan.confirm.pause.title': 'Pause this plan?',
  'myPlan.confirm.pause.content': 'After pausing, this plan will no longer appear under Active Plans on the Today page, but its details and history will be preserved.',
  'myPlan.confirm.pause.ok': 'Confirm Pause',
  'myPlan.confirm.activate.title': 'Resume this plan?',
  'myPlan.confirm.activate.content': 'After resuming, this plan will reappear under Active Plans on the Today page and continue to be tracked.',
  'myPlan.confirm.activate.ok': 'Confirm Resume',
  'myPlan.confirm.archive.title': 'Archive this plan?',
  'myPlan.confirm.archive.content': 'After archiving, this plan will be hidden from default lists and the Today page, but you can still view it in the "Archived" tab.',
  'myPlan.confirm.archive.ok': 'Confirm Archive',
  'myPlan.confirm.delete.title': 'Permanently delete this plan?',
  'myPlan.confirm.delete.content': 'Archiving hides the plan from the default list and Today page. Permanently deleting it cannot be undone. This action does not affect your brokerage account.',
  'myPlan.confirm.delete.ok': 'Delete Permanently',
  'myPlan.confirm.delete.cancel': 'Archive Instead',
  'myPlan.message.processing': 'Processing...',
  'myPlan.message.success': 'Operation successful',
  'myPlan.message.failed': 'Operation failed',
  'myPlan.message.failedRetry': 'Operation failed, please try again',
  'myPlan.message.loadFailed': 'Unable to load plan list. Please try again later.',
  'myPlan.drawer.title': 'Plan Details',
  'myPlan.drawer.loadFailed': 'Failed to load plan details',
  'myPlan.drawer.editSettings': 'Edit Settings',
  'myPlan.drawer.basicConfig': 'Basic Config',
  'myPlan.drawer.totalBudget': 'Total Budget',
  'myPlan.drawer.frequency': 'Frequency',
  'myPlan.drawer.duration': 'Duration',
  'myPlan.drawer.riskProfile': 'Risk Profile',
  'myPlan.drawer.myNotes': 'My Investment Thesis',
  'myPlan.drawer.executionStrategy': 'Execution Strategy (AI Generated)',
  'myPlan.drawer.budgetRules': 'Budget Allocation Rules',
  'myPlan.drawer.baseInvestment': 'Base Investment',
  'myPlan.drawer.drawdownPool': 'Drawdown Reserve',
  'myPlan.drawer.cashBuffer': 'Cash Buffer',
  'myPlan.drawer.dcaSchedule': 'DCA Schedule',
  'myPlan.drawer.dcaNote': 'Fixed investment amount per period · Based on {frequency} cycle',
  'myPlan.drawer.columns.period': 'Period',
  'myPlan.drawer.columns.amount': 'Suggested Amount',
  'myPlan.drawer.columns.note': 'Note',
  'myPlan.drawer.actionRules': 'Action Rules',
  'myPlan.drawer.continueWhen': 'Continue Conditions:',
  'myPlan.drawer.pauseWhen': 'Pause Conditions:',
  'myPlan.drawer.useReserveWhen': 'Use Reserve Conditions:',
  'myPlan.drawer.scenarios': 'Scenario Simulation',
  'myPlan.drawer.scenarios.base': 'Base Case',
  'myPlan.drawer.scenarios.stress': 'Stress Case',
  'myPlan.drawer.scenarios.upside': 'Upside Case',
  'myPlan.drawer.scenarios.sideways': 'Sideways Case',
  'myPlan.drawer.frequencyPlaceholder': 'e.g., Monthly, Weekly, Bi-weekly',
  'myPlan.drawer.durationPlaceholder': 'e.g., 12 months, 3 years',
  'myPlan.drawer.thesisPlaceholder': 'Why are you investing in this asset? What is your personal logic?',
  'myPlan.drawer.cancel': 'Cancel',
  'myPlan.drawer.saveChanges': 'Save Changes',
  'myPlan.drawer.rules.budgetRequired': 'Please input total budget amount',
  'myPlan.drawer.apiError': 'API Request Failed',
  'myPlan.drawer.updateSuccess': 'Plan updated successfully',
  'myPlan.drawer.updateFailed': 'Failed to update plan',

  // Stock Research
  'stockResearch.equityResearch': 'EQUITY RESEARCH',
  'stockResearch.searchPlaceholder': 'Search ticker (e.g. AAPL, MSFT)',
  'stockResearch.searchPlaceholderLong': 'Search ticker, e.g. AAPL, MSFT, NVDA',
  'stockResearch.searchBtn': 'Search',
  'stockResearch.tabs.overview': 'OVERVIEW',
  'stockResearch.tabs.financials': 'FINANCIALS',
  'stockResearch.tabs.technicals': 'TECHNICALS',
  'stockResearch.loadingWorkspace': 'Loading workspace...',
  'stockResearch.title': 'Stock Research',
  'stockResearch.subtitle': 'View basic profile, historical price, financial statements, and valuation metrics to help form your long-term judgment.',
  'stockResearch.popularTitle': 'Popular Research',
  'stockResearch.popularDesc': 'Start with popular assets to jump into the research workbench.',
  'stockResearch.categories.mag7': 'Mag 7 Tech stars',
  'stockResearch.categories.aiSemi': 'AI & Semiconductors',
  'stockResearch.categories.etfs': 'ETFs & Bonds',
  'stockResearch.categories.crypto': 'Crypto-related',
  'stockResearch.categories.chinaHk': 'China ADR / HK Tech',
  'stockResearch.financials.loading': 'Loading financial statements...',
  'stockResearch.financials.incomeStatement': 'INCOME STATEMENT',
  'stockResearch.financials.balanceSheet': 'BALANCE SHEET',
  'stockResearch.financials.cashFlow': 'CASH FLOW',
  'stockResearch.financials.incomeHelper': 'Income statement helps evaluate revenue growth and profitability.',
  'stockResearch.financials.balanceHelper': 'Balance sheet helps assess financial stability, debt, and liquidity.',
  'stockResearch.financials.cashHelper': 'Cash flow statement shows if the company is generating actual cash, not just paper profits.',
  'stockResearch.financials.noData': 'No financial statements data available',
  'stockResearch.financials.metricColumn': 'METRIC',
  'stockResearch.financials.externalAnalysisPrompt': 'Need more detail? View deeper financials on ROIC AI ↗',
  'stockResearch.technicals.calculating': 'Calculating technical indicators...',
  'stockResearch.technicals.disclaimerTitle': 'Technical Reference',
  'stockResearch.technicals.disclaimerBody': 'These indicators describe trend, momentum, volatility, and volume. For research reference only. Not buy/sell recommendations or price predictions.',
  'stockResearch.technicals.trendRef': 'TREND REFERENCE',
  'stockResearch.technicals.momentumRef': 'MOMENTUM REFERENCE',
  'stockResearch.technicals.volatilityRef': 'VOLATILITY REFERENCE',
  'stockResearch.technicals.volumeRef': 'VOLUME REFERENCE',
  'stockResearch.technicals.indicatorColumn': 'INDICATOR',
  'stockResearch.technicals.valueColumn': 'VALUE',
  'stockResearch.technicals.stateColumn': 'MARKET STATE',
  'stockResearch.technicals.states.macd.positive': 'Positive Momentum (Above signal line)',
  'stockResearch.technicals.states.macd.negative': 'Negative Momentum (Below signal line)',
  'stockResearch.technicals.states.neutral': 'Neutral',
  'stockResearch.technicals.states.adx.strong': 'Strong Trend',
  'stockResearch.technicals.states.adx.weak': 'Weak or No Trend',
  'stockResearch.technicals.states.adx.developing': 'Trend Developing',
  'stockResearch.technicals.states.rsi.overbought': 'Overbought (RSI > 70) — Historical High',
  'stockResearch.technicals.states.rsi.oversold': 'Oversold (RSI < 30) — Historical Low',
  'stockResearch.technicals.states.rsi.neutral': 'Neutral Momentum',
  'stockResearch.technicals.states.cci.upper': 'CCI Upper Extreme (> 100)',
  'stockResearch.technicals.states.cci.lower': 'CCI Lower Extreme (< -100)',
  'stockResearch.technicals.states.cci.ranging': 'Ranging / Sideways',
  'stockResearch.technicals.states.momentum.overbought': 'Momentum Overbought',
  'stockResearch.technicals.states.momentum.oversold': 'Momentum Oversold',
  'stockResearch.technicals.states.bb.above': 'Price above Bollinger upper band',
  'stockResearch.technicals.states.bb.below': 'Price below Bollinger lower band',
  'stockResearch.technicals.states.bb.within': 'Operating within Bollinger Bands',
  'stockResearch.technicals.states.cmf.positive': 'Positive Money Flow (CMF > 0.1)',
  'stockResearch.technicals.states.cmf.negative': 'Negative Money Flow (CMF < -0.1)',
  'stockResearch.technicals.states.cmf.neutral': 'Neutral Money Flow',
  'stockResearch.technicals.states.reference': 'Reference Value',
  'stockResearch.technicals.noData': 'No technical indicators data available',

  // Metrics (Financials)
  'stockResearch.metrics.revenue': 'Revenue',
  'stockResearch.metrics.cost_of_revenue': 'Cost of Revenue',
  'stockResearch.metrics.gross_profit': 'Gross Profit',
  'stockResearch.metrics.operating_income': 'Operating Income',
  'stockResearch.metrics.net_income': 'Net Income',
  'stockResearch.metrics.ebitda': 'EBITDA',
  'stockResearch.metrics.ebit': 'EBIT',
  'stockResearch.metrics.interest_expense': 'Interest Expense',
  'stockResearch.metrics.eps_diluted': 'Diluted EPS',
  'stockResearch.metrics.gross_margin': 'Gross Margin',
  'stockResearch.metrics.operating_margin': 'Operating Margin',
  'stockResearch.metrics.net_margin': 'Net Margin',
  'stockResearch.metrics.operating_cash_flow': 'Operating Cash Flow',
  'stockResearch.metrics.capex': 'CapEx',
  'stockResearch.metrics.free_cash_flow': 'Free Cash Flow',
  'stockResearch.metrics.dividends_paid': 'Dividends Paid',
  'stockResearch.metrics.share_buybacks': 'Share Buybacks',
  'stockResearch.metrics.fcf_margin': 'FCF Margin',
  'stockResearch.metrics.capex_to_revenue': 'CapEx to Revenue',
  'stockResearch.metrics.total_assets': 'Total Assets',
  'stockResearch.metrics.current_assets': 'Current Assets',
  'stockResearch.metrics.cash': 'Cash & Equivalents',
  'stockResearch.metrics.receivables': 'Receivables',
  'stockResearch.metrics.inventory': 'Inventory',
  'stockResearch.metrics.net_ppe': 'Net Property, Plant & Equipment',
  'stockResearch.metrics.total_liabilities': 'Total Liabilities',
  'stockResearch.metrics.total_debt': 'Total Debt',
  'stockResearch.metrics.long_term_debt': 'Long-term Debt',
  'stockResearch.metrics.short_term_debt': 'Short-term Debt',
  'stockResearch.metrics.net_debt': 'Net Debt',
  'stockResearch.metrics.total_equity': 'Total Equity',
  'stockResearch.metrics.working_capital': 'Working Capital',
  'stockResearch.metrics.current_ratio': 'Current Ratio',
  'stockResearch.metrics.quick_ratio': 'Quick Ratio',
  'stockResearch.metrics.debt_to_equity': 'Debt to Equity Ratio',
  'stockResearch.metrics.debt_to_assets': 'Debt to Assets Ratio',
  'stockResearch.metrics.roe': 'ROE',
  'stockResearch.metrics.roa': 'ROA',
  'stockResearch.metrics.roic': 'ROIC',
  'stockResearch.metrics.asset_turnover': 'Asset Turnover',
  'stockResearch.metrics.equity_multiplier': 'Equity Multiplier',
  'stockResearch.metrics.dupont_roe': 'DuPont ROE Analysis',

  // Learning / Theory Library
  'learning.title': 'Theory Library',
  'learning.subtitle': 'Structured reading, connected workspaces, and your investment library.',
  'learning.corePlatformKicker': 'Core Framework',
  'learning.ecosystemTitle': 'Connected Workspaces',
  'learning.ecosystemSubtitle': 'External tools and reading environments linked to this system.',
  'learning.libraryTitle': 'Library & Notes',
  'learning.librarySubtitle': 'Personal reading list and curated book references.',
  'learning.externalBadge': 'External Workspace',
  'learning.referenceBadge': 'Reference Space',
  'learning.corePlatform.subtitle': 'Investing Framework, Mental Models & Deep Dives',
  'learning.platforms.newshub.subtitle': 'News intelligence aggregated for market research.',
  'learning.platforms.aiskills.subtitle': 'AI skills and tooling reference hub.',
  ...
  'settings.appearanceRestored': 'Theme Preferences',
  'settings.appearance': 'Appearance',
  'settings.appearanceDesc': 'These controls utilize the original QuantBrew theme engine, persisted via Vuex/localStorage settings.',
  'settings.pagestyleDesc': 'Choose sidebar and global layout shades.',
  'settings.themecolorDesc': 'Set accent color for main controls and navigation.',
  'settings.weakmodeDesc': 'Adjust color weakness accessibility settings.',
  'settings.multitabDesc': 'Retain tabbed workspace navigation.',
  'settings.operationalSettings': 'Service & Parameters Config',
  'settings.operationalSubtitle': 'Security, AI Agents, Data, and Communication Config',
  'settings.operationalDesc': 'Loaded from the server schema. Saving here will update host parameters.',

  // Today Page
  'today.marketTemp.title': 'Market Sentiment',
  'today.marketTemp.badge': 'Macro Overview',
  'today.marketTemp.viewDetails': 'View Macro Details',
  'today.marketTemp.syncing': 'Syncing macro indicators...',
  'today.marketTemp.noDataValue': 'N/A',
  'today.marketTemp.loadingHint': 'Syncing macro indicator data, please wait...',
  'today.marketTemp.loadError': 'Macro data failed to load, please refresh later.',
  'today.marketTemp.footerMessage': 'Some macro indicators are currently unavailable ({percentage}% loaded). Data is sourced from third-party feeds and does not constitute investment advice.',

  'today.dimensions.liquidity': 'Liquidity',
  'today.dimensions.economy': 'Economy',
  'today.dimensions.inflationRates': 'Inflation & Rates',
  'today.dimensions.sentiment': 'Market Sentiment',

  'today.verdicts.Loose': 'Loose',
  'today.verdicts.Tight': 'Tight',
  'today.verdicts.Expanding': 'Expanding',
  'today.verdicts.Slowing': 'Slowing',
  'today.verdicts.Contracting': 'Contracting',
  'today.verdicts.Easing': 'Easing',
  'today.verdicts.HighYield': 'High Yield',
  'today.verdicts.Greed': 'Greed',
  'today.verdicts.Fear': 'Fear',
  'today.verdicts.Neutral': 'Neutral',

  'today.guidance.title': 'Long-term Investor Guidance',
  'today.guidance.p1': 'The indicators above reflect the objective state of the macro environment and market sentiment for background context. They are not intended to predict short-term prices or suggest buy/sell actions.',
  'today.guidance.p2': 'For long-term investors, sticking to your structured entry plan is crucial. Avoid chasing highs or exiting prematurely due to short-term market fluctuations.',

  'today.metrics.FGI.name': 'Fear & Greed Index',
  'today.metrics.FGI.explain': 'Reflects market sentiment extremes. High values suggest overbought conditions/greed, while low values indicate panic and potential counter-cyclical entries.',
  'today.metrics.VIX.name': 'Volatility Index',
  'today.metrics.VIX.explain': 'S&P 500 implied volatility, often called the fear gauge. Low levels indicate market complacency; spikes signal rising hedging demand and tail risk.',
  'today.metrics.DXY.name': 'US Dollar Index',
  'today.metrics.DXY.explain': 'Measures USD strength against major currencies. A weaker USD typically enhances global liquidity and alleviates valuation pressures on risk assets.',
  'today.metrics.US10Y.name': '10-Year Treasury Yield',
  'today.metrics.US10Y.explain': '10-Year US Treasury yield, the benchmark for global asset pricing. Rising yields raise borrowing costs and compress valuation multiples for risk assets.',

  'today.watchlist.title': 'Watchlist',
  'today.watchlist.badge': 'Favorites',
  'today.watchlist.syncing': 'Syncing watchlist...',
  'today.watchlist.loadError': 'Failed to load watchlist, please try again later.',
  'today.watchlist.btnGoSnapshot': 'Go to Asset Snapshot',
  'today.watchlist.emptyTitle': 'No watched assets yet',
  'today.watchlist.emptyDesc': 'Search for stocks, ETFs, or Crypto in Asset Snapshot and add them to your watchlist. You will see their daily performance and status alerts here on the Today dashboard.',

  'today.activePlans.title': 'Active Plans',
  'today.activePlans.badge': 'Disciplined Execution',
  'today.activePlans.viewAll': 'View All',
  'today.activePlans.moreLink': 'View all {count} plans →',
  'today.activePlans.emptyTitle': 'No active investment plans',
  'today.activePlans.emptyDesc': 'Create a long-term DCA or split-purchase plan, logging entry setups, invalidation parameters, and risk control. Plans are designed to cultivate execution discipline amid market volatility, not to forecast short-term directions.',
  'today.activePlans.btnCreate': 'Create Plan',

  'today.activePlans.status.active': 'Active',
  'today.activePlans.status.paused': 'Paused',
  'today.activePlans.status.draft': 'Draft',
  'today.activePlans.status.completed': 'Completed',
  'today.activePlans.status.cancelled': 'Cancelled',
  'today.activePlans.status.archived': 'Archived',

  // Macro Page
  'macro.title': 'Market Temperature',
  'macro.subtitle': 'Macro Indicators & Educational Framework',
  'macro.nonAi': 'Rule-based · Non-AI Generated',
  'macro.dataAsOf': 'Data as of: {time}',
  'macro.provenance.aiObsoleteTitle': 'Legacy AI Summary (Obsolete)',
  'macro.provenance.aiObsoleteDesc': 'This system has shifted to transparent rules and an educational framework. The legacy AI summary below is for reference only and is no longer used as a core judgment.',
  'macro.provenance.expandAiSummary': 'Expand to view historical AI summary',
  'macro.provenance.riskPosture': 'Risk Posture',

  'macro.warnings.degraded.title': 'System Data Degraded',
  ...
  'macro.branches.liquidity.desc': 'Liquidity measures capital abundance and credit availability in the financial system. Ample liquidity supports asset valuations, while tighter financial conditions increase pressure.',

  'macro.branches.fundamentals.title': 'Fundamentals',
  'macro.branches.fundamentals.summary': 'Economic state: {state}',
  'macro.branches.fundamentals.desc': 'Fundamentals reflect the health and growth momentum of the real economy, while long-term yields serve as the risk-free discount rate. Economic expansion fuels corporate profits, whereas rising treasury yields raise the cost of capital.',

  'macro.branches.inflation.title': 'Inflation',
  'macro.branches.inflation.summary': 'Inflation & Rate: {state}',
  'macro.branches.inflation.desc': 'Inflation is the primary anchor for central bank monetary policy. CPI, PCE, and Core PCE monitor price levels, while the 10-year breakeven rate reflects the bond market\'s long-term inflation expectations.',

  'macro.branches.sentiment.title': 'Sentiment',
  'macro.branches.sentiment.summary': 'Sentiment: {state}',
  'macro.branches.sentiment.desc': 'Sentiment measures short-term investor risk appetite and panic levels. Sentiment metrics are often contrarian; extreme greed warns of valuation bubbles, while extreme fear can present asymmetric risk-reward opportunities.',

  'macro.action.deepDive': 'Detailed Analysis & Charts',
  'macro.card.definition': 'Definition',
  'macro.card.implication': 'Current State Implication',
  'macro.card.relationships': 'Transmission & Related Indicators',
  'macro.card.source': 'Source',
  'macro.card.frequency': 'Frequency',
  'macro.card.lastUpdated': 'Last Updated',
  'macro.card.noData': 'No Data',
  'macro.card.calculating': 'Calculating',

  'macro.detail.derivedFromSeries': 'Latest value derived from history',
  'macro.detail.currentMeaning': 'Current Implication',
  'macro.detail.indicatorSpec': 'Metric Description',
  'macro.detail.risingMeans': '↑ Rising means',
  'macro.detail.fallingMeans': '↓ Falling means',
  'macro.detail.riskAssetImplication': 'Impact on Risk Assets',
  'macro.detail.chartUnavailable': 'Chart temporarily unavailable',
  'macro.detail.dataUnavailable': 'Data temporarily unavailable',

  // Verdict Translations
  'macro.verdicts.Loose': 'Easing',
  'macro.verdicts.Tight': 'Tighter',
  'macro.verdicts.Expanding': 'Expanding',
  'macro.verdicts.Slowing': 'Slowing',
  'macro.verdicts.Contracting': 'Contracting',
  'macro.verdicts.Easing': 'Easing',
  'macro.verdicts.HighYield': 'High Yield Restraint',
  'macro.verdicts.Greed': 'Greed',
  'macro.verdicts.Fear': 'Fear',
  'macro.verdicts.Neutral': 'Neutral',

  // Indicator Meta translations
  'macro.indicators.fgi.label': 'Fear & Greed Index',
  'macro.indicators.fgi.what': 'Measures stock market emotions on a scale of 0 to 100 based on metrics like treasury demand, stock price momentum, and option volatility.',
  'macro.indicators.fgi.whyItMatters': 'High readings suggest excessive optimism (market overbought), while low values signal widespread panic (oversold). For sentiment tracking only; does not predict exact entry/exit points.',
  'macro.indicators.fgi.rel.vix': 'During times of extreme fear, the VIX index typically spikes in tandem.',
  'macro.indicators.fear_greed.label': 'Fear & Greed Index',
  'macro.indicators.fear_greed.what': 'Measures stock market emotions on a scale of 0 to 100 based on metrics like treasury demand, stock price momentum, and option volatility.',
  'macro.indicators.fear_greed.whyItMatters': 'High readings suggest excessive optimism, while low values signal widespread panic. For sentiment tracking only; it does not predict exact entry or exit points.',
  'macro.indicators.fear_greed.rel.vix': 'During periods of extreme fear, VIX usually spikes in tandem.',

  'macro.indicators.vix.label': 'CBOE Volatility Index',
  'macro.indicators.vix.what': 'Measures the 30-day implied volatility of the S&P 500 index derived from option pricing. Often dubbed the market\'s "fear gauge".',
  'macro.indicators.vix.whyItMatters': 'Reflects the market\'s expected volatility. Higher readings signal investor apprehension and wider anticipated swings.',
  'macro.indicators.vix.rel.fear_greed': 'A sharp spike in implied volatility usually pushes the FGI index deep into fear territory.',

  'macro.indicators.dxy.label': 'US Dollar Index',
  'macro.indicators.dxy.what': 'Tracks the value of the U.S. dollar relative to a basket of major foreign currencies (e.g., EUR, JPY).',
  'macro.indicators.dxy.whyItMatters': 'Serves as an indicator of global USD funding. A stronger dollar indicates offshore liquidity withdrawal, posing a headwind for global equities and credit markets.',
  'macro.indicators.dxy.rel.nfci': 'A persistently strong dollar is often accompanied by a tightening in global financial conditions indices.',

  'macro.indicators.rrp.label': 'Fed Overnight Reverse Repo',
  'macro.indicators.rrp.what': 'Reflects idle liquidity that money market funds and eligible financial institutions park overnight at the Federal Reserve.',
  'macro.indicators.rrp.whyItMatters': 'Acts as a monetary shock absorber. Declining RRP balances release cash back into the private sector, temporarily offsetting liquidity drains.',
  'macro.indicators.rrp.rel.nfci': 'The release of RRP funds generally helps alleviate acute credit market pressures.',

  'macro.indicators.nfci.label': 'National Financial Conditions Index',
  'macro.indicators.nfci.what': 'A weekly index published by the Chicago Fed that combines 105 sub-indicators across credit spreads, leverage, and funding stress.',
  'macro.indicators.nfci.whyItMatters': 'Measures U.S. financial system stress. Readings below zero represent loose financing conditions, while positive readings signify tightening.',
  'macro.indicators.nfci.rel.us10y': 'Tighter financial conditions are frequently associated with increased volatility in long-term treasury yields.',

  'macro.indicators.gdp.label': 'GDP Growth (QoQ Ann.)',
  'macro.indicators.gdp.what': 'The annualized rate at which inflation-adjusted economic output and consumption grow on a quarterly basis.',
  'macro.indicators.gdp.whyItMatters': 'Tracks the expansion speed of the real economy. Steady GDP growth provides the fundamental demand needed for corporate earnings growth.',
  'macro.indicators.gdp.rel.cpi': 'Overly robust economic output (heating up) may spark upward pressure on consumer price inflation.',

  'macro.indicators.cpi.label': 'CPI YoY Change',
  'macro.indicators.cpi.what': 'Measures changes in the price level of consumer goods and services (e.g., food, housing, healthcare) purchased by households.',
  'macro.indicators.cpi.whyItMatters': 'A key metric for Fed rate decisions. High inflation constrains room for rate cuts, compelling policymakers to maintain restrictive policy.',
  'macro.indicators.cpi.rel.us10y': 'Elevated inflation expectations generally push nominal 10-year yields higher.',
  'macro.indicators.cpi.rel.pce_yoy': 'PCE and CPI have different weightings, but a unified trend strengthens the inflation signal.',

  'macro.indicators.pce_yoy.label': 'PCE Price Index YoY',
  'macro.indicators.pce_yoy.what': 'Published by the BEA, tracking changes in prices paid for personal consumption. Broader and more responsive to substitution than CPI.',
  'macro.indicators.pce_yoy.whyItMatters': 'The Federal Reserve\'s preferred inflation yardstick. Readings above the 2% target increase the likelihood of restrictive monetary policy.',
  'macro.indicators.pce_yoy.rel.core_pce_yoy': 'Core PCE (excluding food and energy) is better suited to capture structural, sticky inflation trends.',

  'macro.indicators.core_pce_yoy.label': 'Core PCE YoY Change',
  'macro.indicators.core_pce_yoy.what': 'Personal consumption expenditures excluding food and energy, representing the underlying inflation trend.',
  'macro.indicators.core_pce_yoy.whyItMatters': 'The core inflation metric referencing Fed rate adjustments. Core PCE persistently above 2% delays rate cuts and keeps policy restrictive.',
  'macro.indicators.core_pce_yoy.rel.breakeven_10y': 'Rising core PCE can lift long-term inflation expectations, further pressuring long-term yields.',

  'macro.indicators.breakeven_10y.label': '10-Year Breakeven Inflation Rate',
  'macro.indicators.breakeven_10y.what': 'The nominal 10-year treasury yield minus the 10-year inflation-protected treasury (TIPS) yield, representing implied inflation expectations.',
  'macro.indicators.breakeven_10y.whyItMatters': 'Readings far above 2% indicate market concern over unanchored inflation. Sharp drops hint at slowing growth or deflation risks.',
  'macro.indicators.breakeven_10y.rel.us10y': 'Higher inflation expectations push nominal yields up, adding valuation headwinds.',

  'macro.indicators.us10y.label': '10-Year Treasury Yield',
  'macro.indicators.us10y.what': 'The yield to maturity on 10-year U.S. government debt, globally recognized as the risk-free rate anchor.',
  'macro.indicators.us10y.whyItMatters': 'Directly influences borrowing costs and discount rates. Higher yields compress growth stock valuations by reducing the present value of future cash flows.',
  'macro.indicators.us10y.rel.vix': 'A sudden, sharp rise in yields often triggers volatility spikes in the equity markets.',

  // Rules Evaluations
  'macro.rules.unknown.label': 'Unknown',
  'macro.rules.unknown.meaning': 'Data unavailable, cannot evaluate.',

  'macro.rules.fgi.extreme_fear.label': 'Extreme Fear',
  'macro.rules.fgi.extreme_fear.meaning': 'Market sentiment is deeply pessimistic. Historically, this indicates a period of extremely low risk appetite.',
  'macro.rules.fgi.fear.label': 'Fear',
  'macro.rules.fgi.fear.meaning': 'The market is cautious, and investor risk appetite has noticeably cooled down.',
  'macro.rules.fgi.neutral.label': 'Neutral',
  'macro.rules.fgi.neutral.meaning': 'Sentiment is balanced between bulls and bears; no extreme fear or greed is observed.',
  'macro.rules.fgi.greed.label': 'Greed',
  'macro.rules.fgi.greed.meaning': 'Sentiment is optimistic and risk appetite is rising. Watch for expanding valuation premiums.',
  'macro.rules.fgi.extreme_greed.label': 'Extreme Greed',
  'macro.rules.fgi.extreme_greed.meaning': 'Sentiment is highly euphoric. Asset prices may have priced in all positive catalysts, raising downside risks.',

  'macro.rules.vix.stable.label': 'Stable & Complacent',
  'macro.rules.vix.stable.meaning': 'Implied volatility is low, indicating a calm market. However, watch for potential complacency and structural shifts.',
  'macro.rules.vix.moderate.label': 'Moderate Volatility',
  'macro.rules.vix.moderate.meaning': 'The market exhibits moderate uncertainty, with volatility trading near historical averages.',
  'macro.rules.vix.spike.label': 'Volatility Spike',
  'macro.rules.vix.spike.meaning': 'Implied volatility has spiked significantly, signaling heightened systemic fear and strong risk-off sentiment.',

  'macro.rules.us10y.low.label': 'Low Yield',
  'macro.rules.us10y.low.meaning': 'Long-term risk-free rates are low, easing corporate discount pressure and supporting valuation expansion.',
  'macro.rules.us10y.neutral.label': 'Neutral Yield',
  'macro.rules.us10y.neutral.meaning': 'U.S. Treasury yields are in a standard range; overall pressure on the broader market is manageable.',
  'macro.rules.us10y.high.label': 'High Yield',
  'macro.rules.us10y.high.meaning': 'Yields exceed 4.5%. The elevated discount rate pressures valuations of growth stocks and long-duration assets.',

  'macro.rules.dxy.weak.label': 'Weak Dollar',
  'macro.rules.dxy.weak.meaning': 'A soft dollar index helps ease liquidity pressure on non-U.S. markets and global credit flows.',
  'macro.rules.dxy.neutral.label': 'Neutral Dollar',
  'macro.rules.dxy.neutral.meaning': 'The dollar is range-bound, showing no clear directional influence on global offshore funding.',
  'macro.rules.dxy.strong.label': 'Strong Dollar',
  'macro.rules.dxy.strong.meaning': 'A strengthening dollar attracts global capital back to the U.S., prompting marginal tightening in offshore liquidity.',

  'macro.rules.nfci.loose.label': 'Very Loose',
  'macro.rules.nfci.loose.meaning': 'Credit, leverage, and funding stress are very low, indicating an highly accommodative financial environment.',
  'macro.rules.nfci.moderately_loose.label': 'Moderately Loose',
  'macro.rules.nfci.moderately_loose.meaning': 'Overall financial conditions lean loose. Credit channels remain open with no signs of severe tightening.',
  'macro.rules.nfci.neutral_tight.label': 'Neutral-Tight',
  'macro.rules.nfci.neutral_tight.meaning': 'Funding costs and credit spreads have ticked up, signaling marginal tightening in credit channels.',
  'macro.rules.nfci.tight.label': 'Very Tight',
  'macro.rules.nfci.tight.meaning': 'Credit channels are highly constrained, credit spreads are widening rapidly, and systemic leverage is contracting.',

  'macro.rules.rrp.low.label': 'Low Buffer',
  'macro.rules.rrp.low.meaning': 'The RRP balance is low, meaning financial reserve cushions are depleted, reducing liquidity safety nets.',
  'macro.rules.rrp.moderate.label': 'Moderate Buffer',
  'macro.rules.rrp.moderate.meaning': 'The RRP maintains a standard balance, providing basic support for routine liquidity fluctuations.',
  'macro.rules.rrp.ample.label': 'Ample Buffer',
  'macro.rules.rrp.ample.meaning': 'The RRP balance is substantial, indicating high cash reserves and a solid liquidity buffer in the financial system.',

  'macro.rules.gdp.recession.label': 'Recession',
  'macro.rules.gdp.recession.meaning': 'Negative growth indicates a technical or actual recession, posing a severe environment for corporate revenues.',
  'macro.rules.gdp.slow.label': 'Slow Growth',
  'macro.rules.gdp.slow.meaning': 'GDP growth is below historical averages, indicating risks of slowing economic momentum.',
  'macro.rules.gdp.expanding.label': 'Steady Expansion',
  'macro.rules.gdp.expanding.meaning': 'Economic output is growing steadily, reflecting healthy and solid macro demand.',

  'macro.rules.cpi.controlled.label': 'Well Controlled',
  'macro.rules.cpi.controlled.meaning': 'Inflation is near the long-term 2% target, creating more room for rate cuts or dovish policy shifts.',
  'macro.rules.cpi.sticky.label': 'Moderate Stickiness',
  'macro.rules.cpi.sticky.meaning': 'Disinflation has stalled, showing stickiness that could slow down the pace of monetary policy easing.',
  'macro.rules.cpi.high.label': 'Persistently High',
  'macro.rules.cpi.high.meaning': 'Price pressures remain pronounced, eroding real purchasing power and limiting the Fed\'s policy flexibility.',

  'macro.rules.pce_yoy.controlled.label': 'Near Target',
  'macro.rules.pce_yoy.controlled.meaning': 'PCE inflation is nearing the 2% target, bolstering the Fed\'s confidence and policy flexibility.',
  'macro.rules.pce_yoy.sticky.label': 'Moderately High',
  'macro.rules.pce_yoy.sticky.meaning': 'PCE is still above target; the Fed requires more evidence of a sustainable downtrend before easing policy.',
  'macro.rules.pce_yoy.high.label': 'Sticky & High',
  'macro.rules.pce_yoy.high.meaning': 'PCE is significantly above the target, forcing the Fed to maintain a restrictive stance and pressuring valuations.',

  'macro.rules.core_pce_yoy.controlled.label': 'Easing Consensus',
  'macro.rules.core_pce_yoy.controlled.meaning': 'Core PCE has moderated to acceptable levels, aligning market rate expectations and easing yields.',
  'macro.rules.core_pce_yoy.sticky.label': 'Persistent Stickiness',
  'macro.rules.core_pce_yoy.sticky.meaning': 'Core disinflation is slower than expected. Easing conditions are not fully ripe; policy shifts will be gradual.',
  'macro.rules.core_pce_yoy.high.label': 'Persistent Pressure',
  'macro.rules.core_pce_yoy.high.meaning': 'High core inflation keeps the Fed locked in a restrictive rate range, weighing heavily on growth stocks.',

  'macro.rules.breakeven_10y.controlled.label': 'Mild Expectations',
  'macro.rules.breakeven_10y.controlled.meaning': 'Long-term inflation expectations are low, limiting risks of a sudden spike in real yields.',
  'macro.rules.breakeven_10y.sticky.label': 'Neutral Expectations',
  'macro.rules.breakeven_10y.sticky.meaning': 'Market inflation expectations remain anchored near the 2% target, keeping rate volatility neutral.',
  'macro.rules.breakeven_10y.high.label': 'Above Target',
  'macro.rules.breakeven_10y.high.meaning': 'Expectations exceed 2%, and concerns over resurgent inflation will drive up term premiums on long yields.',

  // Macro Detail page translation keys
  'macro.detail.back': '← Back to Macro Landscape',
  'macro.detail.legendDisclaimer': 'Note: This page contains three types of content: Rule-based verdicts are automatically computed based on macro indicators; Static educational cards explain indicator definitions; AI Briefing is displayed only when generated by a validated model.',
  'macro.detail.currentStance': 'Current Stance',
  'macro.detail.ruleBasedProvenance': 'Rule-Based Verdict · Based on {metrics}',
  'macro.detail.provenanceFallback': 'Data',
  'macro.detail.implicationHeader': 'Implications for Risk Assets',
  'macro.detail.drivingForceAnalysis': 'Driving Force Analysis',
  'macro.detail.supportingFactors': '✅ Tailwinds for Risk Assets',
  'macro.detail.pressuringFactors': '⚠️ Headwinds for Risk Assets',
  'macro.detail.keyCatalysts': 'Watchlist / Key Catalysts',
  'macro.detail.showAdvanced': 'Show Advanced Metrics',
  'macro.detail.hideAdvanced': 'Hide Advanced Metrics',

  // Education section strings
  'macro.education.howToRead': 'How to Read These Indicators',
  'macro.education.guideExpand': 'Guide',
  'macro.education.guideCollapse': 'Collapse',
  'macro.education.guideSubTitle': 'Learn indicators definition, related factors, and key quantile range configurations.',
  'macro.education.legendBadge': 'Static Explanation · Non-AI Generated · Not part of today\'s verdict',
  'macro.education.relatedData': 'Related Data:',
  'macro.education.pendingData': '(To be integrated)',
  'macro.education.whyItMatters': 'Why It Matters:',
  'macro.education.keyIntervals': 'Key Intervals:',

  // Domains
  'macro.detail.domains.liquidity.title': 'Liquidity',
  'macro.detail.domains.liquidity.subtitle': 'Fed Balance Sheet & Financial System Liquidity',
  'macro.detail.domains.economy.title': 'Economy',
  'macro.detail.domains.economy.subtitle': 'Growth Momentum & Labor Market Health',
  'macro.detail.domains.inflationRates.title': 'Inflation & Rates',
  'macro.detail.domains.inflationRates.subtitle': 'Price Pressures & Yield Curve Inversion',
  'macro.detail.domains.sentiment.title': 'Market Sentiment',
  'macro.detail.domains.sentiment.subtitle': 'Risk Appetite Indicators',

  // Categories
  'macro.detail.categories.fed_core': 'Fed Core Liquidity',
  'macro.detail.categories.financial_conditions': 'Financial Conditions',
  'macro.detail.categories.usd_global': 'USD & Global Liquidity',
  'macro.detail.categories.inflation_pressure': 'Inflationary Pressures',
  'macro.detail.categories.rates_curve': 'Rates & Yield Curve',
  'macro.detail.categories.expectations_commodities': 'Inflation Expectations & Commodities',
  'macro.detail.categories.economic_growth': 'Economic Growth',
  'macro.detail.categories.employment_market': 'Labor Market',
  'macro.detail.categories.credit_environment': 'Credit & Default Risk',
  'macro.detail.categories.market_sentiment': 'Market Sentiment Indicators',
  'macro.detail.categories.volatility_indices': 'Volatility & Fear Indices',

  // Last Updated formats
  'macro.detail.lastUpdatedWithData': 'Rule updated: {updateTime} · Data as of: {dataTime}',
  'macro.detail.lastUpdatedTime': 'Rule updated: {updateTime}',

  // Dynamic status updates - Liquidity
  'macro.detail.liquidity.verdict.warning': 'USD Liquidity Neutral-Tight',
  'macro.detail.liquidity.thesis.warning': 'Under a strong USD regime, global credit costs rise and offshore dollar liquidity tightens, exerting valuation pressure on risk assets.',
  'macro.detail.liquidity.verdict.success': 'Liquidity Marginally Loose',
  'macro.detail.liquidity.thesis.success': 'A weaker USD environment lowers global borrowing costs and supports liquidity expansion, fundamentally backing current risk exposures.',
  'macro.detail.liquidity.verdict.neutral': 'Systemic Liquidity Balanced',
  'macro.detail.liquidity.thesis.neutral': 'Liquidity conditions are in a balanced consolidation phase. Refrain from frequent exposure adjustments based on short-term noise.',
  'macro.detail.liquidity.verdict.processing': 'Tracking Underlying Liquidity',
  'macro.detail.liquidity.thesis.processing': 'Core liquidity indicators are temporarily unavailable; downgraded to a cautious stance. Avoid expanding risk exposure in a data vacuum.',
  'macro.detail.liquidity.implication.success': 'A weaker USD lowers borrowing costs and eases offshore liquidity; macro conditions support maintaining current risk exposures.',
  'macro.detail.liquidity.implication.default': 'During periods of a strong USD or tightening liquidity, rising credit costs squeeze high-beta assets. New deployments should remain prudent.',
  'macro.detail.liquidity.tailwinds.0': 'RRP balances continue to release, injecting cash and supporting market liquidity.',
  'macro.detail.liquidity.tailwinds.1': 'Declining TGA balances release liquidity, temporarily cushioning the market.',
  'macro.detail.liquidity.tailwinds.2': 'NFCI remains in negative territory, showing relatively loose systemic financial conditions.',
  'macro.detail.liquidity.tailwinds.3': 'A slowdown or pause in Fed QT reduces passive balance sheet shrinkage pressures.',
  'macro.detail.liquidity.headwinds.0': 'Ongoing QT passively shrinks the Fed balance sheet, posing long-term downward pressure on net liquidity.',
  'macro.detail.liquidity.headwinds.1': 'Massive Treasury issuance to rebuild the TGA temporarily drains liquidity from the system.',
  'macro.detail.liquidity.headwinds.2': 'If RRP balances drain to zero, future liquidity contractions will lose their primary buffer.',
  'macro.detail.liquidity.headwinds.3': 'A stronger USD pushes up offshore funding costs and dampens global risk appetite.',
  'macro.detail.liquidity.whatToWatch.0.label': 'RRP Balances',
  'macro.detail.liquidity.whatToWatch.0.desc': 'If RRP approaches depletion (below $50B), the market loses its primary liquidity buffer.',
  'macro.detail.liquidity.whatToWatch.1.label': 'TGA Movements',
  'macro.detail.liquidity.whatToWatch.1.desc': 'Monitor Treasury issuance pace and TGA levels to assess potential liquidity-draining effects.',
  'macro.detail.liquidity.whatToWatch.2.label': 'Bank Reserves Level',
  'macro.detail.liquidity.whatToWatch.2.desc': 'If reserves drop below the $3T comfort zone, look out for sudden spikes in overnight lending rates.',
  'macro.detail.liquidity.whatToWatch.3.label': 'NFCI Direction',
  'macro.detail.liquidity.whatToWatch.3.desc': 'A turn to positive values indicates tightening financial conditions, signaling a need to review risk limits.',

  // Dynamic status updates - InflationRates
  'macro.detail.inflationRates.verdict.warning': 'Yield Curve Inverted',
  'macro.detail.inflationRates.thesis.warning': 'Persistent yield curve inversion historically precedes recessions. Long-term portfolios should verify downside tolerance.',
  'macro.detail.inflationRates.verdict.success': 'Healthy Curve Steepening',
  'macro.detail.inflationRates.thesis.success': 'Yield curve steepens healthily alongside inflation and growth, providing fundamental support for cyclical assets.',
  'macro.detail.inflationRates.verdict.neutral': 'Yield Curve Flattening',
  'macro.detail.inflationRates.thesis.neutral': 'A flattening curve indicates growth momentum requires confirmation. Avoid chasing high-duration assets here.',
  'macro.detail.inflationRates.verdict.processing': 'Risk-Free Rate Pricing',
  'macro.detail.inflationRates.thesis.processing': 'Key interest rate indicators are temporarily unavailable. Stance downgraded; pace long-duration asset configurations prudently.',
  'macro.detail.inflationRates.implication': 'Risk-free rates and inflation stickiness define the boundaries of valuation expansion; lower long-term yields will improve risk-asset tolerance.',
  'macro.detail.inflationRates.tailwinds.0': 'Core inflation continues to cool, providing room for Fed policy normalization.',
  'macro.detail.inflationRates.tailwinds.1': 'A decline in long-term yields (US10Y) eases valuation pressure on long-duration assets.',
  'macro.detail.inflationRates.tailwinds.2': 'Core commodity prices remain moderate, lowering the risk of imported inflation.',
  'macro.detail.inflationRates.headwinds.0': 'Sticky service inflation (especially shelter costs) may limit rate-cut expectations.',
  'macro.detail.inflationRates.headwinds.1': 'A persistently tight labor market could revive wage-price spiral risks.',
  'macro.detail.inflationRates.headwinds.2': 'Deep yield curve inversion continues to price in potential economic recession risks.',
  'macro.detail.inflationRates.whatToWatch.0.label': 'Core PCE Trend',
  'macro.detail.inflationRates.whatToWatch.0.desc': 'Observe whether core PCE stably trends down to the Fed target, confirming disinflation.',
  'macro.detail.inflationRates.whatToWatch.1.label': 'US10Y Key Levels',
  'macro.detail.inflationRates.whatToWatch.1.desc': 'A break above key yield resistance levels will directly compress growth and tech valuations.',

  // Dynamic status updates - Economy
  'macro.detail.economy.verdict.danger': 'Labor Market Cooling',
  'macro.detail.economy.thesis.danger': 'Unemployment has risen near the Sahm Rule threshold. Recession signals are intensifying; review defensive portfolio contingencies.',
  'macro.detail.economy.verdict.success': 'Robust Economic Momentum',
  'macro.detail.economy.thesis.success': 'Strong labor market and solid consumer demand support fundamentals, though watch out for sticky inflation\'s effect on the Fed.',
  'macro.detail.economy.verdict.neutral': 'Soft Landing Trajectory',
  'macro.detail.economy.thesis.neutral': 'Labor market rebalancing and moderate non-disruptive slowing support a soft landing. Maintain execution pace.',
  'macro.detail.economy.verdict.processing': 'Real Economy Tracking',
  'macro.detail.economy.thesis.processing': 'Key economic data is temporarily unavailable; stance downgraded. Avoid modifying allocations in a data vacuum.',
  'macro.detail.economy.implication': 'Economic resilience supports corporate earnings, but hot data during tightening cycles can trigger rate volatility and indirectly squeeze liquidity.',
  'macro.detail.economy.tailwinds.0': 'Retail sales remain resilient, showing stable consumer demand.',
  'macro.detail.economy.tailwinds.1': 'Jobless claims stay low, providing a solid cushion for a soft landing.',
  'macro.detail.economy.tailwinds.2': 'High-yield spreads show no significant widening, indicating healthy credit access.',
  'macro.detail.economy.headwinds.0': 'Manufacturing PMI stays below the expansion threshold, indicating weak industrial momentum.',
  'macro.detail.economy.headwinds.1': 'Tighter bank lending standards pose credit constraints for the real economy.',
  'macro.detail.economy.headwinds.2': 'Delinquencies in credit cards and auto loans are rising, reflecting stress in low-income consumer debt.',
  'macro.detail.economy.whatToWatch.0.label': 'Unemployment Uptrend',
  'macro.detail.economy.whatToWatch.0.desc': 'An unemployment rate rise that triggers the Sahm Rule significantly raises recession risks.',
  'macro.detail.economy.whatToWatch.1.label': 'Credit Spread Widening',
  'macro.detail.economy.whatToWatch.1.desc': 'Rapid widening of high-yield spreads indicates credit risk pricing and deteriorating conditions.',

  // Dynamic status updates - Sentiment
  'macro.detail.sentiment.verdict.success': 'Extreme Fear (Potential Buying Point)',
  'macro.detail.sentiment.thesis.success': 'Market sentiment is near freezing. From a disciplined execution perspective, executing plans now historically outperforms panic selling.',
  'macro.detail.sentiment.verdict.warning': 'Extreme Greed (Risk Accumulating)',
  'macro.detail.sentiment.thesis.warning': 'Highly elevated sentiment reduces risk-asset tolerance. Avoid chasing highs; re-evaluate whether original holding theses still stand.',
  'macro.detail.sentiment.verdict.neutral': 'Sentiment Range-Bound',
  'macro.detail.sentiment.thesis.neutral': 'Neutral sentiment lacks clear direction. Maintain existing execution pace and minimize unstructured portfolio churning.',
  'macro.detail.sentiment.verdict.processing': 'Market Sentiment Sensing',
  'macro.detail.sentiment.thesis.processing': 'Sentiment indicators are temporarily unavailable. Stance downgraded; do not expand or contract risk based on sentiment.',
  'macro.detail.sentiment.implication': 'Sentiment extremes often trigger short-term overshooting. If systemic risks are contained, fear zones present attractive entry points.',
  'macro.detail.sentiment.tailwinds.0': 'Extreme fear typically exhausts selling pressure, laying a foundation for medium-term support.',
  'macro.detail.sentiment.tailwinds.1': 'A spike and subsequent retracement in VIX helps stabilize risk asset allocations.',
  'macro.detail.sentiment.tailwinds.2': 'Put/Call ratios reaching extreme highs indicate potential contrarian reversal momentum.',
  'macro.detail.sentiment.headwinds.0': 'Entering extreme greed is often accompanied by high leverage, significantly lowering asset margin of safety.',
  'macro.detail.sentiment.headwinds.1': 'A deeply backwardated VIX term structure indicates strong short-term hedging demand.',
  'macro.detail.sentiment.headwinds.2': 'Speculative bubbles paired with institutional distribution raise short-term correction risks.',
  'macro.detail.sentiment.whatToWatch.0.label': 'VIX Term Structure',
  'macro.detail.sentiment.whatToWatch.0.desc': 'VIX futures inversion signals persistent panic. Normalization of the curve is a leading indicator of sentiment stabilizing.',
  'macro.detail.sentiment.whatToWatch.1.label': 'Greed/Fear Extremes',
  'macro.detail.sentiment.whatToWatch.1.desc': 'Extreme greed suggests highly vulnerable market structures. Consider pacing plan executions during such periods.',

  // Fallbacks
  'macro.detail.default.verdict': 'Observing Momentum',
  'macro.detail.default.thesis': 'Loading data, please wait...',

  // ── Metric Registry Descriptions ──────────────────────────────────────────
  // Liquidity – Fed Core
  'macro.registry.us_net_liquidity.currentMeaning': 'Net Fed balance sheet (WALCL minus TGA and RRP) — the most accurate real-time proxy for liquidity available to markets.',
  'macro.registry.us_net_liquidity.risingMeans': 'Usable liquidity is expanding, supporting risk-asset valuations via a liquidity premium.',
  'macro.registry.us_net_liquidity.fallingMeans': 'Liquidity is contracting; markets lack fresh ammunition and face valuation compression risk.',
  'macro.registry.us_net_liquidity.riskAssetImpact': 'Net liquidity is the gravitational force behind risk-asset pricing — rising net liquidity typically expands valuation multiples.',

  'macro.registry.fed_balance_sheet.currentMeaning': 'Total Fed assets — a direct read on the progress of quantitative easing (QE) or tightening (QT).',
  'macro.registry.fed_balance_sheet.risingMeans': 'The central bank is expanding its balance sheet, injecting base money into the system.',
  'macro.registry.fed_balance_sheet.fallingMeans': 'The central bank is shrinking its balance sheet, withdrawing liquidity from the system.',

  'macro.registry.tga_balance.currentMeaning': 'The Treasury\'s cash account at the Fed — changes in the balance directly affect banking-system liquidity.',
  'macro.registry.tga_balance.risingMeans': 'TGA rising = Treasury is draining liquidity from markets, acting like a stealth tightening.',
  'macro.registry.tga_balance.fallingMeans': 'TGA falling = Treasury is injecting liquidity into the banking system, supporting risk assets.',

  'macro.registry.rrp_balance.currentMeaning': 'Overnight cash parked at the Fed by financial institutions — high balances mean excess liquidity is locked away rather than circulating.',
  'macro.registry.rrp_balance.risingMeans': 'RRP rising = funds have nowhere to go and are locked at the Fed, providing limited direct benefit to risk assets.',
  'macro.registry.rrp_balance.fallingMeans': 'RRP falling = funds flow back into markets, improving liquidity; once near zero the buffer disappears.',

  'macro.registry.bank_reserves.currentMeaning': 'Excess reserves held by commercial banks at the Fed — the core fuel for credit expansion and financial system stability.',
  'macro.registry.bank_reserves.risingMeans': 'Ample reserves support bank lending capacity and generally indicate loose financial conditions.',
  'macro.registry.bank_reserves.fallingMeans': 'If reserves fall below the ~$3T comfort zone, funding stress may rise and overnight rates can spike.',

  'macro.registry.financial_conditions_index.currentMeaning': 'Aggregated measure of credit spreads, leverage, and risk indicators; zero is the historical average, negative = loose.',
  'macro.registry.financial_conditions_index.risingMeans': 'NFCI > 0 = financial conditions tightening, borrowing costs rising, economic activity under pressure.',
  'macro.registry.financial_conditions_index.fallingMeans': 'NFCI < 0 = financial conditions loose, credit flowing freely, risk assets benefit.',

  // Liquidity – FX
  'macro.registry.sofr.currentMeaning': 'Secured Overnight Financing Rate — the successor to USD LIBOR and the benchmark for short-term dollar funding costs.',
  'macro.registry.effective_fed_funds_rate.currentMeaning': 'The actual overnight interbank lending rate — the realized policy rate target.',
  'macro.registry.dollar_index.currentMeaning': 'Benchmark for USD strength against major currencies — the most intuitive barometer of global liquidity conditions.',
  'macro.registry.dollar_index.risingMeans': 'Stronger dollar pressures non-USD assets and tightens offshore dollar liquidity.',
  'macro.registry.dollar_index.fallingMeans': 'Weaker dollar eases global funding costs, favoring risk assets and carry trades.',
  'macro.registry.dollar_index.riskAssetImpact': 'A weaker USD typically nurtures global risk appetite; a strong USD acts like a liquidity vacuum.',
  'macro.registry.usd_jpy.currentMeaning': 'USD/JPY exchange rate — a window into BoJ policy interventions and yen carry-trade dynamics.',
  'macro.registry.eur_usd.currentMeaning': 'EUR/USD rate — reflects the relative strength of the dollar versus the euro.',
  'macro.registry.ecb_balance_sheet.currentMeaning': 'Scale of ECB liquidity injected into markets via asset purchases and LTRO programs.',
  'macro.registry.boj_balance_sheet.currentMeaning': 'Magnitude of BoJ monetary expansion and its impact on global yen-funded carry trades.',
  'macro.registry.global_m2_proxy.currentMeaning': 'Proxy for aggregate global broad money supply across major central banks.',

  // Inflation – Pressure
  'macro.registry.cpi_yoy.currentMeaning': 'Headline consumer price index year-over-year — the broadest measure of overall inflation.',
  'macro.registry.core_cpi_yoy.currentMeaning': 'CPI excluding food and energy — captures demand-driven, sticky inflation trends.',
  'macro.registry.pce_yoy.currentMeaning': 'Personal Consumption Expenditures price index — the Fed\'s official benchmark inflation target.',
  'macro.registry.core_pce_yoy.currentMeaning': 'Core PCE — the Fed\'s preferred inflation gauge for setting interest rate policy.',
  'macro.registry.ppi_yoy.currentMeaning': 'Producer Price Index — an upstream cost indicator that leads CPI and PCE trends.',
  'macro.registry.shelter_inflation.currentMeaning': 'Shelter component of CPI — the largest and stickiest sub-index driving core inflation.',
  'macro.registry.supercore_inflation.currentMeaning': 'Supercore inflation (core services ex-shelter) — measures purely service-sector price pressures.',

  // Rates – Curve
  'macro.registry.us10y_yield.currentMeaning': '10-year US Treasury yield — the global anchor for financial asset pricing and the risk-free rate benchmark.',
  'macro.registry.us10y_yield.risingMeans': 'Rising long-end rates increase the discount rate, compressing valuations for long-duration assets like growth stocks.',
  'macro.registry.us10y_yield.fallingMeans': 'Falling long-end rates ease liquidity expectations and benefit risk assets and gold.',

  'macro.registry.us2y_yield.currentMeaning': '2-year US Treasury yield — the most sensitive instrument to near-term Federal Reserve rate expectations.',
  'macro.registry.us30y_yield.currentMeaning': '30-year US Treasury yield — reflects long-run growth and inflation expectations embedded in the bond market.',
  'macro.registry.term_spread_10y_2y.currentMeaning': '10Y–2Y yield spread — the classic yield-curve shape indicator; inversion historically precedes recessions.',
  'macro.registry.real_yield_10y.currentMeaning': '10-year real yield (nominal minus inflation expectations) — the true cost of capital and core driver of gold and tech multiples.',
  'macro.registry.fed_funds_rate.currentMeaning': 'The Fed\'s nominal policy rate ceiling — the official benchmark for overnight interbank lending.',

  // Inflation – Expectations & Commodities
  'macro.registry.inflation_expectations_1y.currentMeaning': 'Consumer near-term inflation expectations for the next 12 months.',
  'macro.registry.inflation_expectations_5y.currentMeaning': 'Long-run inflation anchoring benchmark closely monitored by the Fed.',
  'macro.registry.wti_crude.currentMeaning': 'WTI crude oil price — the benchmark energy cost indicator for the US and global economy.',
  'macro.registry.brent_crude.currentMeaning': 'Brent crude price — the international benchmark for globally traded oil.',
  'macro.registry.copper.currentMeaning': '"Dr. Copper" price — highly sensitive to global industrial demand and advanced manufacturing activity.',
  'macro.registry.gold.currentMeaning': 'Gold spot price — a safe-haven asset that hedges against fiat debasement, geopolitical risk, and falling real yields.',

  // Economy – Growth
  'macro.registry.gdp_growth.currentMeaning': 'Real GDP annualized quarter-over-quarter growth rate — the broadest measure of economic output.',
  'macro.registry.retail_sales_yoy.currentMeaning': 'Retail sales year-over-year — directly measures consumer spending, which drives ~70% of US GDP.',
  'macro.registry.industrial_production_yoy.currentMeaning': 'Industrial production year-over-year — gauges manufacturing, mining, and utilities output.',
  'macro.registry.consumer_confidence.currentMeaning': 'University of Michigan Consumer Sentiment Index — a leading indicator for future household spending.',
  'macro.registry.recession_probability.currentMeaning': 'Smoothed recession probability model based on yield-curve and other factors.',

  // Economy – Employment
  'macro.registry.unemployment_rate.currentMeaning': 'Unemployment rate — triggers the Sahm Rule near its threshold, typically confirming recession onset.',
  'macro.registry.nonfarm_payrolls.currentMeaning': 'Monthly nonfarm payrolls — the most closely watched high-frequency measure of labor market health.',
  'macro.registry.initial_jobless_claims.currentMeaning': 'Weekly initial jobless claims — the earliest and sharpest high-frequency signal of labor market deterioration.',
  'macro.registry.continuing_claims.currentMeaning': 'Continuing jobless claims — reflects how difficult it is for unemployed workers to find new jobs.',
  'macro.registry.jolts_openings.currentMeaning': 'JOLTS job openings — measures labor demand and the tightness between supply and demand.',
  'macro.registry.wage_growth.currentMeaning': 'Average hourly earnings year-over-year — the primary driver of sticky service-sector inflation.',
  'macro.registry.labor_force_participation.currentMeaning': 'Labor force participation rate — reflects long-term structural shifts in labor supply.',

  // Economy – Credit
  'macro.registry.hy_spread.currentMeaning': 'High-yield (junk bond) credit spread — smart-money pricing of corporate default risk.',
  'macro.registry.ig_spread.currentMeaning': 'Investment-grade credit spread — a broad indicator of corporate financing health.',
  'macro.registry.bank_lending_standards.currentMeaning': 'Net tightening share of bank lending standards — leads actual credit contraction.',
  'macro.registry.delinquency_rate.currentMeaning': 'Commercial loan delinquency rate — measures realized debt-servicing stress in the real economy.',
  'macro.registry.commercial_paper_spread.currentMeaning': 'Commercial paper spread — a thermometer for short-term corporate funding stress.',

  // Sentiment
  'macro.registry.fear_greed.currentMeaning': 'CNN Fear & Greed Index — extreme fear historically presents buying opportunities; extreme greed signals elevated risk.',
  'macro.registry.vix.currentMeaning': 'S&P 500 implied volatility index — commonly called the "fear gauge" of financial markets.',
  'macro.registry.vxn.currentMeaning': 'Nasdaq-100 implied volatility — the fear gauge for the technology-heavy index.',
  'macro.registry.gvz.currentMeaning': 'Gold volatility index — reflects market pricing of extreme safe-haven demand events.',
  'macro.registry.vix_term.currentMeaning': 'VIX term structure ratio (front/back) — inversion signals acute short-term panic.',
  'macro.registry.aaii_sentiment.currentMeaning': 'AAII investor sentiment survey — extreme bearish readings are often contrarian bottoming signals.',
  'macro.registry.put_call_ratio.currentMeaning': 'Put/Call options volume ratio — reflects directional bias and hedging demand in the options market.',
  // Decision & Sandbox Tools — Section header + card copy
  'learning.sandboxTitle': 'Decision & Sandbox Tools',
  'learning.sandboxSubtitle': 'Interactive financial modeling, growth simulations, and debt analysis.',
  'learning.sandbox.asset.title': 'Long-Term Returns & Compounding Sandbox',
  'learning.sandbox.asset.subtitle': 'Simulate long-term asset growth paths, DCA impacts, and break-even thresholds.',
  'learning.sandbox.asset.badge': 'Asset Modeling',
  'learning.sandbox.debt.title': 'Debt Amortization & Cash Flow Sandbox',
  'learning.sandbox.debt.subtitle': 'Analyze debt amortization curves and consolidate loans to quantify monthly cash outflow.',
  'learning.sandbox.debt.badge': 'Debt Assessment',
  'learning.sandbox.realestate.title': 'Real Estate Investment Decision Sandbox',
  'learning.sandbox.realestate.subtitle': 'Analyze property acquisition returns, structural depreciation tax shields, and rental cash flows.',
  'learning.sandbox.realestate.badge': 'Property Deal Analysis',
  'learning.sandbox.openTool': 'Open Sandbox',

  // Real Estate Drawer Labels
  'learning.realestate.drawerTitle': 'Real Estate Investment Decision Sandbox',
  'learning.realestate.tabReturn': '1. Return Outlook',
  'learning.realestate.tabDepreciation': '2. Depreciation & Tax Shield',
  'learning.realestate.tabCashflow': '3. Cash-Flow & BRRRR Reality',

  'learning.realestate.purchasePrice': 'Purchase Price',
  ...
  'learning.realestate.interestRate': 'Mortgage Rate (%)',
  'learning.realestate.loanTermYears': 'Mortgage Term (Years)',
  'learning.realestate.loanPointsPercent': 'Loan Points (%)',
  ...
  'learning.realestate.vacancyPercent': 'Vacancy Allowance (%)',
  'learning.realestate.capexPercent': 'Capital Expenditures (%)',
  'learning.realestate.managementPercent': 'Management Fees (%)',
  'learning.realestate.electricity': 'Electricity / Power',
  'learning.realestate.water': 'Water / Sewer',
  'learning.realestate.gas': 'Gas / Heating',
  'learning.realestate.hoa': 'HOA Fees',
  'learning.realestate.garbage': 'Garbage Service',
  'learning.realestate.pmi': 'Private Mortgage Insurance (PMI)',
  'learning.realestate.otherExpenses': 'Other Monthly Expenses',

  'learning.realestate.buildingValue': 'Building Structure Value (Excluding Land)',
  'learning.realestate.marginalTaxRate': 'Marginal Income Tax Rate (%)',
  'learning.realestate.depreciationPeriod': 'Depreciation Schedule (IRS)',
  'learning.realestate.depreciationPeriod.27.5': '27.5 Years (Residential Rental)',
  'learning.realestate.depreciationPeriod.39': '39 Years (Commercial property)',
  'learning.realestate.depreciationPeriod.15': '15 Years (Land Improvement)',

  'learning.realestate.refinanceLtv': 'Refinance LTV (%)',
  'learning.realestate.refinanceInterestRate': 'Refinance Interest Rate (%)',
  'learning.realestate.refinanceTermYears': 'Refinance Term (Years)',
  'learning.realestate.refinanceClosingCosts': 'Refinance Closing Costs',

  'learning.realestate.result.netCashflow': 'Net Monthly Cash Flow',
  'learning.realestate.result.operatingExpenses': 'Operating Expenses',
  'learning.realestate.result.piPayment': 'Monthly P&I Debt',
  'learning.realestate.result.roi': 'Cash-on-Cash ROI',
  'learning.realestate.result.noi': 'Annual NOI',
  'learning.realestate.result.purchaseCap': 'Purchase Cap Rate',
  'learning.realestate.result.proformaCap': 'Pro Forma Cap Rate',
  'learning.realestate.result.totalInvested': 'Total Cash Invested',
  'learning.realestate.result.dcr': 'Debt Coverage Ratio (DCR)',
  'learning.realestate.result.annualDepreciation': 'Annual Depreciation',
  'learning.realestate.result.taxSavings': 'Annual Tax Savings',
  'learning.realestate.result.afterTaxCashflow': 'After-Tax Cash Flow',
  'learning.realestate.result.cashLeft': 'Actual Cash Left in Deal',
  'learning.realestate.result.cashOut': 'Refinance Cash Pulled Out',
  'learning.realestate.result.initialOutlay': 'Total Initial Cash Outlay',

  'learning.realestate.explain.dcr': 'Warning: Debt Coverage Ratio (DCR) is below 1.20. Traditional commercial lenders may consider this deal high-risk.',
  'learning.realestate.explain.depreciation': 'The IRS allows you to write off the wear and tear of a physical structure (building value only) over 27.5 years. Land does not depreciate.',
  'learning.realestate.explain.infiniteRoi': 'Infinite ROI Achieved! You successfully pulled out more cash than your initial investment (recovering closing costs and rehab). The deal has no owner capital left in it.',
  'learning.realestate.explain.negativeCashflow': 'Warning: Refinancing leads to negative monthly cash flow. Ensure your rent covers the increased mortgage payment or reconsider refinance LTV.',
  'learning.realestate.chart.title': 'Accumulated Tax Shield Savings',
  'learning.realestate.chart.note': 'Projected savings over the structure depreciation schedule.',
  'learning.realestate.chart.xLabel': 'Year',
  'learning.realestate.chart.yLabel': 'Savings ($)',

  'learning.realestate.sectionAcquisition': 'Acquisition Parameters',
  'learning.realestate.sectionFinancing': 'Financing Structure',
  'learning.realestate.sectionOutlayTitle': 'Capital Outlay & Debt Commitment',
  'learning.realestate.totalAcquisitionCost': 'Total Acquisition Cost',
  'learning.realestate.totalCashRequired': 'Total Cash Required',
  'learning.realestate.financedLoanAmount': 'Financed Loan Amount',
  'learning.realestate.monthlyPiPayment': 'Monthly P&I Debt Payment',
  'learning.realestate.conceptReturnTitle': 'Return Outlook Concept',
  'learning.realestate.conceptReturnDesc': 'Return Outlook focuses on your capital allocation at entry. Total Cash Required represents the actual cash you must bring to the closing table (down payment, points, closing fees, and rehab costs), while the Monthly P&I represents your structural debt commitment.',
  'learning.realestate.sectionDepreciationTitle': 'Depreciation Shield Outlook',
  'learning.realestate.adjustedAfterTaxCashflow': 'Adjusted After-Tax Cash Flow',
  'learning.realestate.conceptDepreciationTitle': 'Depreciation Shield Concept',
  'learning.realestate.sectionIncomeExpenses': 'Income & Operating Expenses',
  'learning.realestate.sectionBrrrr': 'BRRRR Refinance Option',
  'learning.realestate.sectionOpsSummary': 'Operating Performance & Refinancing Summary',
  'learning.realestate.grossMonthlyIncome': 'Gross Monthly Income',
  'learning.realestate.preRefiCashFlow': 'Pre-Refi Cash Flow',
  'learning.realestate.preRefiCocRoi': 'Pre-Refi CoC ROI',
  'learning.realestate.refinanceYieldAnalytics': 'Refinance Yield Analytics',
  'learning.realestate.postRefiCashFlow': 'Post-Refi Cash Flow',
  'learning.realestate.postRefiCocRoi': 'Post-Refi CoC ROI',
  'learning.realestate.infiniteRoiAlert': 'Infinite ROI Alert',
  'learning.realestate.negativeCashflowWarning': 'Negative Cash Flow Warning',
  ...
  'learning.asset.frequency.4': 'Quarterly',
  'learning.asset.frequency.12': 'Monthly',
  'learning.asset.frequency.52': 'Weekly',
  'learning.asset.dcaFrequency': 'Deposit Cycle',
  'learning.asset.dcaFreq.1': 'Annually',
  'learning.asset.dcaFreq.4': 'Quarterly',
  'learning.asset.dcaFreq.12': 'Monthly',
  'learning.asset.dcaTiming': 'Deposit Execution Timing',
  'learning.asset.currentValue': 'Fair Market Value',
  'learning.asset.btnCalculate': 'Run Simulation',
  'learning.asset.result.title': 'Calculation Summary',
  'learning.asset.result.type': 'Calculation Type:',
  'learning.asset.result.overallReturn': 'Overall Return (ROI):',
  'learning.asset.result.formulaTitle': 'Formula Reference:',
  'learning.asset.result.recoveryTitle': 'Drawdown Assessment:',
  'learning.asset.result.noLoss': 'Portfolio is currently profitable. Accrued gain is approximately {gain}%.',
  'learning.asset.chart.dcaLegendWealth': 'Accrued Wealth (FV)',
  'learning.debt.tabAmortization': 'Single Loan Amortization',
  'learning.debt.rate': 'Annual Financing Rate (%)',
  'learning.debt.years': 'Amortization Term (Years)',
  'learning.debt.repayMode': 'Amortization Structure',
  'learning.debt.paymentsPerYear': 'Annual Payment Frequency',
  'learning.debt.freq.12': '12 Periods (Monthly)',
  'learning.debt.freq.6': '6 Periods (Bi-Monthly)',
  'learning.debt.freq.4': '4 Periods (Quarterly)',
  'learning.debt.result.title': 'Amortization Report',
  'learning.debt.table.title': 'Amortization Schedule Table',
  'learning.debt.table.show': 'Show Schedule Grid',
  'learning.debt.table.period': '期数',
  'learning.debt.table.startBal': '期初余额',
  'learning.debt.table.endBal': '期末余额',
  'learning.debt.portfolio.addBtn': '+ 添加一笔贷款',
  'learning.debt.portfolio.clearBtn': '清空全部',
  'learning.debt.portfolio.calcBtn': '合并计算',
  'learning.debt.portfolio.loanName': '贷款项目 #{index}',
  'learning.debt.portfolio.remove': '移除',
  'learning.debt.portfolio.totalPay': '累计还款总额：',
  'learning.debt.portfolio.totalMonthly': '合并每月总还款：',
  'learning.asset.drawerTitle': 'Long-Term Returns & Compounding Sandbox',
  'learning.asset.tabGrowth': 'Asset Growth Simulation',
  'learning.asset.tabRecovery': 'Drawdown Recovery Model',
  'learning.asset.principal': 'Starting Capital',
  'learning.asset.interestType': 'Growth Model',
  'learning.asset.dcaAmount': 'Periodic Deposit Amount',
  'learning.asset.timing.begin': 'Beginning of Period (Annuity Due)',
  'learning.asset.timing.end': 'End of Period (Ordinary Annuity)',
  'learning.asset.initialInvestment': 'Cost Basis',
  'learning.asset.btnReset': 'Reset Parameters',
  'learning.asset.result.finalAmount': 'Final Balance (FV):',
  'learning.asset.result.totalInvested': 'Total Principal Invested:',
  'learning.asset.result.totalInterest': 'Total Interest Accrued:',
  'learning.asset.result.totalReturn': 'Total Portfolio Gain:',
  'learning.asset.result.lossDetail': 'Portfolio is currently in drawdown. Total loss is {loss}%. Without compounding, it will require a gain of {recovery}% to break even and restore the initial principal.',
  'learning.asset.chart.title': 'Asset Growth Trend (Line Chart)',
  'learning.asset.chart.dcaTitle': 'Wealth Accumulation Curve (Area Chart)',
  'learning.asset.chart.dcaLegendPrincipal': 'Principal Invested',
  'learning.asset.chart.note': 'Note: Grey curve represents simple growth (for contrast), colored curve represents compound growth.',
  'learning.asset.warning.dca': 'Disclaimer: This sandbox is for strategy modeling and analysis. Projections and expected rates of return do not constitute guaranteed investment yields.',
  'learning.asset.warning.loss': 'Asymmetric Recovery Effect: Portfolio drawdowns and recovery requirements are mathematically asymmetrical. Greater drawdowns require exponentially higher returns to recover (e.g., a 50% drawdown requires a 100% recovery return), meaning high drawdowns heavily dilute long-term CAGR.',
  'learning.debt.drawerTitle': 'Debt Amortization & Cash Flow Sandbox',
  'learning.debt.tabPortfolio': 'Multi-Debt Consolidation',
  'learning.debt.amount': 'Financing Principal (Yuan)',
  'learning.debt.mode.annuity': 'Equated Monthly Installment (EMI)',
  'learning.debt.mode.principal': 'Equal Principal Repayment (EPR)',
  'learning.debt.mode.annuity.desc': 'EMI: Periodic payment is fixed. Initial periods consist of higher interest percentages, leading to a slower initial principal reduction, incurring more interest. Suitable for cash flows with strict monthly budget restrictions.',
  'learning.debt.mode.principal.desc': 'EPR: Principal repayment is constant. Because the balance reduces linearly, period payments decrease over time. Total interest is lower, but initial periods carry a higher cash outflow overhead.',
  'learning.debt.result.monthlyPay': 'Initial Payment: {first} / Final Payment: {last} (Average: {avg})',
  'learning.debt.result.monthlyPayFixed': 'Fixed Periodic Payment: {amount}',
  'learning.debt.result.totalInterest': 'Total Interest Paid:',
  'learning.debt.result.totalPayment': 'Total Cost of Loan:',
  'learning.debt.chart.balanceTitle': 'Remaining Loan Principal Trend (Ending Balance)',
  'learning.debt.chart.balanceDesc': 'X-axis is payment period, Y-axis is remaining principal. A flatter curve indicates slower principal reduction.',
  'learning.debt.table.hide': 'Hide Schedule Grid',
  'learning.debt.table.pay': 'Payment',
  'learning.debt.table.principal': 'Principal Paid',
  'learning.debt.table.interest': 'Interest Paid',
  'learning.debt.portfolio.title': 'Debt Portfolio',
  'learning.debt.portfolio.summaryTitle': '📊 Consolidated Debt Cash Flow Summary',
  'learning.debt.portfolio.totalLoans': 'Active Loan Count:',
  'learning.debt.portfolio.totalPrincipal': 'Total Principal:',
  'learning.debt.portfolio.totalInterest': 'Total Lifetime Interest:',
  'learning.debt.portfolio.totalMonthlyDesc': 'Note: Consolidated Monthly Payments is the sum of all monthly obligations, representing the rigid cash flow pressure on your balance sheet.',
  'learning.debt.warning.footer': 'Note: Calculations use standardized mathematical formulas. Actual bank rates, compounding models, and payment terms will vary.',
  'learning.asset.result.insight': 'Research Sandbox Insight:',
  'learning.debt.result.comparison': 'Structure Comparison Insight:',
  'learning.asset.result.multiplier': 'Capital Growth Multiplier:',
  'learning.asset.result.ratio': 'Interest Contribution Ratio:',
  'learning.asset.result.insightText': 'Expected wealth will grow to {multiplier}x of starting capital, with compounding growth accounting for {ratio}% of the final portfolio balance.',
  'learning.debt.result.comparisonText': 'Structure Comparison: EPR structure saves ¥{savings} in lifetime interest vs. EMI. However, during the initial phases, first period cash outlays are {premium}% higher.',
  'learning.asset.result.dcaInsightText': 'Expected wealth will grow to {multiplier}x of total invested principal, with compounding growth accounting for {ratio}% of the final portfolio balance.',
  // Real Estate Diagnosis Keys
  'learning.realestate.diagnosis.title': 'Deal Diagnosis & Decision Guidance',
  'learning.realestate.diagnosis.dealProfile': 'Deal Profile',
  'learning.realestate.diagnosis.type.cashflow': 'Cash-Flow Driven Deal',
  'learning.realestate.diagnosis.type.cashflow.desc': 'This deal generates strong current cash returns relative to cash invested. Priority is steady rental yield.',
  'learning.realestate.diagnosis.type.appreciation': 'Value-Add / Appreciation dependent',
  'learning.realestate.diagnosis.type.appreciation.desc': 'Operating cash flow is thin; the primary upside relies on value-add renovation or market growth (ARV premium).',
  'learning.realestate.diagnosis.type.refinance': 'Refinance-Sensitive / Leverage Play',
  'learning.realestate.diagnosis.type.refinance.desc': 'This deal depends heavily on refinancing (recovering down payment/rehab capital) to achieve a high return on equity.',
  'learning.realestate.diagnosis.type.balanced': 'Balanced / Standard Profile',
  'learning.realestate.diagnosis.type.balanced.desc': 'A standard investment profile showing moderate cash flow and stable leverage coverage.',
  'learning.realestate.diagnosis.resilience.resilient': 'Resilient Operating Cash Flow',
  'learning.realestate.diagnosis.resilience.resilient.desc': 'Healthy monthly cash surplus provides a robust buffer against vacancy spikes or maintenance surprises.',
  'learning.realestate.diagnosis.resilience.fragile': 'Fragile Cash Flow',
  'learning.realestate.diagnosis.resilience.fragile.desc': 'Thin monthly cash flow. Minor adjustments in expenses, vacancy, or rent cuts could put operations into a deficit.',
  'learning.realestate.diagnosis.resilience.deficit': 'Operating Cash Flow Deficit',
  'learning.realestate.diagnosis.resilience.deficit.desc': 'Expenses and financing exceed monthly income. You must inject capital to support monthly operations.',
  'learning.realestate.diagnosis.burden.healthy': 'Healthy Debt Coverage',
  'learning.realestate.diagnosis.burden.healthy.desc': 'Debt Service Coverage Ratio (DSCR) is safe, leaving a comfortable cushion over required mortgage payments.',
  'learning.realestate.diagnosis.burden.tight': 'Tight Leverage / Financing Pressure',
  'learning.realestate.diagnosis.burden.tight.desc': 'Debt Service Coverage Ratio (DSCR) is close to 1.0 or negative, indicating potential cash flow strain from mortgage obligations.',
  'learning.realestate.diagnosis.burden.none': 'Zero Leverage / All Cash Play',
  'learning.realestate.diagnosis.burden.none.desc': 'No mortgage debt burden. Lower structural risk, though return on equity may be lower without leverage magnification.',
  'learning.realestate.diagnosis.tax.high': 'Significant Tax Shield Lift',
  'learning.realestate.diagnosis.tax.high.desc': 'Depreciation shield significantly offsets rental income tax liability, materially lifting your effective after-tax return.',
