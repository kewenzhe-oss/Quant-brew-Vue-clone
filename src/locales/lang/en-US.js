...
const locale = {
  ...
  'trading-assistant.form.localDeploymentHint': 'IBKR and MT5 are external trading interfaces that require local deployment of PostSoma Core. Cloud SaaS mode is not supported. Please ensure you have installed and configured the trading software (TWS/IB Gateway or MT5 terminal) on your local machine.',
  ...
  'trading-assistant.editor.docsIntroDesc': 'These are the commonly used PostSoma Core script strategy APIs and lifecycle hooks, so you can code and look up usage side by side.',
  ...
  'quickTrade.tpslRecordOnlyHint': 'Note: TP/SL prices are saved in PostSoma Core trade records only. They are not sent to the exchange as native TP/SL or trigger orders. Set exchange-side TP/SL on the exchange if you need that.',
  ...
  'profile.exchange.openAccountPromo': 'PostSoma Core exclusive signup — up to 20% commission rebate',
  ...
  'profile.exchange.localDeploymentHint': 'This broker requires local deployment of PostSoma Core to use.',
